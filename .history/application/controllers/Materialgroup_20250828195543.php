...
class Materialgroup extends CI_Controller {
    public function index(){
        ...
        $result['measurement']=$this->Materialgroupinfo->Getmeasurement();
        $result['materialcategory']=$this->Materialgroupinfo->Getmaterialcategory();
		$result['materialcolor']=$this->Materialgroupinfo->Getmaterialcolor();
		$result['materialcategorygauge']=$this->Materialgroupinfo->Getmaterialcategorygauge();
		$result['supplierlist']=$this->Materialgroupinfo->Getsupplier();
    ...
    public function Materialgroupupload(){
		$this->load->model('Materialgroupinfo');
        $result=$this->Materialgroupinfo->Materialgroupupload();
	}
    public function Materialgroupcheck(){
		$this->load->model('Materialgroupinfo');
        $result=$this->Materialgroupinfo->Materialgroupcheck();
	}
    public function Getlabelinforaccomaterial(){
		$this->load->model('Materialgroupinfo');
        $result=$this->Materialgroupinfo->Getlabelinforaccomaterial();
	}
    public function Getgrninfoaccogrnid(){
		$this->load->model('Materialgroupinfo');
        $result=$this->Materialgroupinfo->Getgrninfoaccogrnid();
	}
	public function Getmaterialinfo(){
		$this->load->model('Materialgroupinfo');
        $result=$this->Materialgroupinfo->Getmaterialinfo();
	}
