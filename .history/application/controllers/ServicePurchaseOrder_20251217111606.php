...
class ServicePurchaseOrder extends CI_Controller {
	...
	public function Purchaseordercheckstatus(){
		$this->load->model('ServicePurchaseOrderinfo');
        $result=$this->ServicePurchaseOrderinfo->Purchaseordercheckstatus();
	}
	public function POmanualconfirm($x){
		$this->load->model('ServicePurchaseOrderinfo');
        $result=$this->ServicePurchaseOrderinfo->POmanualconfirm($x);
	}
	public function Purchaseorderrejectstatus(){
		$this->load->model('ServicePurchaseOrderinfo');
        $result=$this->ServicePurchaseOrderinfo->Purchaseorderrejectstatus();
	}
    ...
    public function Getproductaccosupplier(){
		$this->load->model('ServicePurchaseOrderinfo');
        $result=$this->ServicePurchaseOrderinfo->Getproductaccosupplier();
	}
	public function Getpordertpeaccoporderrequest(){
		$this->load->model('ServicePurchaseOrderinfo');
        $result=$this->ServicePurchaseOrderinfo->Getpordertpeaccoporderrequest();
	}
	public function Getmesuretpeaccorproduct(){
		$this->load->model('ServicePurchaseOrderinfo');
        $result=$this->ServicePurchaseOrderinfo->Getmesuretpeaccorproduct();
	}
