							...
							<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
								<form id="createorderform" autocomplete="off">
									<div class="form-row mb-1">
										<div class="col">
											...
											<input type="date" class="form-control form-control-sm" placeholder=""
												name="issuedate" id="issuedate" onchange="getVat();"
												value="<?php echo date('Y-m-d') ?>" required>
										</div>
										<div class="col">
											<label class="small font-weight-bold text-dark">Item
												Request*</label>
											<select class="form-control form-control-sm" name="itemrequest" id="itemrequest">
									...
									<div class="form-group mb-1">
										<input type="hidden" id="company" name="company" class="form-control form-control-sm"
											value="<?php echo $_SESSION['branch_id']; ?>" required readonly>
									</div>
										...
										<div class="col">
											...
											<select class="form-control form-control-sm" name="employee" id="employee" required>
												...
												<option value="<?php echo $rowemployeelist->id ?>">
													<?php echo $rowemployeelist->emp_name_with_initial .'-'. $rowemployeelist->emp_id?>
												</option>
												<?php } ?>
											</select>
										</div>
									...
									<div class="form-group mb-1">
										...
										<select class="form-control form-control-sm" name="batchno[]" id="batchno" required
                                            ...
                                            <!-- card for showing request details -->
                                            <div id="requestCard" class="card mt-2" style="display:none;">
                                                <div class="card-header small font-weight-bold">Request Details</div>
...
<script>
	...
	$('#itemrequest').change(function () {
		...
		// hide card if nothing selected
		if (itemreqID === "") {
			$('#requestCard').hide();
			return;
		}

		// fetch request details and populate card
		$.ajax({
			type: "POST",
			data: { recordID: itemreqID },
