                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="scrollbar pb-3" id="style-2">
                                    <table class="table table-bordered table-striped table-sm nowrap" id="servicePOTable">
                                        <thead>
                                            <tr>
...
$(document).ready(function() {
    ...
    $('#servicePOTable tbody').on('click', '.btnEdit', function () {
    	Swal.fire({
    		title: "Are you sure?",
