                        ...
                        <form id="createorderform" autocomplete="off">
                            ...
                            <div class="form-group mb-1">
                                ...
                                <select class="form-control form-control-sm" name="servicematerial" id="servicematerial">
                                    <option value="">Select</option>
                                    <?php foreach($servicemateriallist->result() as $rowservicemateriallist){ ?>
                                    <option value="<?php echo $rowservicemateriallist->idtbl_print_porder_detail ?>">
                                        <?php echo $rowservicemateriallist->comment ?></option>
                                    <?php } ?>
                                </select>
                            </div>
    		...
    		$.ajax({
    			...
    			success: function (result) {
    				try {
                        ...
                        if (pieces > 0) {
                            newqty1 = pieces - actualQty;
                            console.log(newqty1);
                            newqty = newqty1 / conversion_qty;
                            qtyLabel = newqty;
    					...
    					$('#piecesper_qty').closest('.form-group').toggle(pieces > 0);
