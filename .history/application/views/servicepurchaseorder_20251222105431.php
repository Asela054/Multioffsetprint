        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    ...
                    button += '<button data-toggle="tooltip" data-placement="bottom" title="View PO" class="btn btn-dark btn-sm btnview mr-1" id="' + full['idtbl_print_porder'] + '" porder_no="' + full['porder_no'] + '" aproval_id="' + full['confirmstatus'] + '" check_status="' + full['check_by'] + '" request_id="' + full['tbl_print_porder_req_idtbl_print_porder_req'] +'"><i class="fas fa-eye"></i></button>';
