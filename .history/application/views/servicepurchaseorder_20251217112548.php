...
$(document).ready(function() {
    ...
    $("#editproduct").select2({
		...
		width: '100%',
		ajax: {
			url: "<?php echo base_url() ?>Se/GetProductList",
			type: "post",
			dataType: 'json',
			delay: 250,
    	...
    	Swal.fire({
    		...
    		if (result.isConfirmed) {
    			...
    			$.ajax({
    				...
    				url: '<?php echo base_url() ?>Se/Purchaseorderedit',
    ...
    $('#editproduct').change(function () {
    	...
    	var supplier = $('#editsupplier').val();
    		...
    		$.ajax({
    			type: "POST",
    			url: 'Se/Getproductinfoaccoproduct',
    			data: {
    				recordID: productID,
    				supplier: supplier 			
                },
