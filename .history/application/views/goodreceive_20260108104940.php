                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                        <form id="createorderform" autocomplete="off">
                            ...
                            <div class="form-group mb-1">
                                <label class="small font-weight-bold text-dark">Service *</label>
                                <select class="form-control form-control-sm" name="location" id="location">
                                    <option value="">Select</option>
                                    <?php foreach($locationlist->result() as $rowlocationlist){ ?>
                                    <option value="<?php echo $rowlocationlist->idtbl_print_porder_detail ?>">
                                        <?php echo $rowlocationlist->comment ?></option>
                                    <?php } ?>
                                </select>
                            </div>
