    ...
    $('#dataTable').DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    var button = '';
                    button+='<button class="btn btn-yellow btn-sm btnUpdatevattype mr-1" id="'+full['idtbl_print_grn']+'" data-toggle="tooltip" data-placement="bottom" title="Update "><i class="fas fa-marker"></i></button>';
