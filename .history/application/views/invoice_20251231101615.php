...
$(document).ready(function() {
    ...
    $('#btnapprovereject').click(function () {
        Swal.fire({
            title: "Do you want to approve this inquiry?",
            html: `
                <div style="text-align:left;margin-top:10px;">
                    <input type="checkbox" id="finishJob" />
                    <label for="finishJob" style="margin-left:6px;">
...
$('#approve').click(async function () {
    ...
    var r = await Swal.fire({
        ...
        html: `
            <div style="text-align:left;margin-top:10px;">
                <input type="checkbox" id="finish_job">
                <label for="finish_job" style="margin-left:6px;">
                    Do you want to finish this job?
                </label>
            </div>
        `,
        ...
        preConfirm: () => {
            return {
                finish_job: $('#finish_job').is(':checked') ? 1 : 0
            };
        }
    });
    ...
    let finishJob = r.value.finish_job;

    let approvebtn = $('#approvebtn').val();
    let dispatchid = $('#reqestid').val();
    let hiddenjobid = $('#hiddenjobid').val();
    let jsonObj = [];
    ...
    $.ajax({
        ...
        data: {
            ...
            hiddenjobid: hiddenjobid,
            finish_job: finishJob, // ✅ send checkbox value
            tableData: jsonObj
        },
        success: function (result) {
            ...
            Swal.fire({
                ...
                text: objfirst.status == 1
                    ...
                    : objfirst.message || "Something went wrong.",
        ...
        didOpen: () => {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    hiddenjobid: $('#hiddenjobid').val(),
                    confirmnot: confirmnot,
                    finish_job: finishJob, // ✅ FIX
                    tableData: jsonObj
                },
                success: function(result) {
                    Swal.close();
    ...
    Swal.fire({
        ...
        didOpen: () => {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>Invoice/Invoicecheckstatus',
                success: function(result) {
                    Swal.close();
                    document.body.style.overflow = 'auto';
                    var obj = JSON.parse(result);
