    ...
    $('#datatable').DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    var button = '';
                    button+='<button class="btn btn-primary btn-sm btnAddremarks mr-1" id="'+full['idtbl_customerinquiry']+'" data-toggle="tooltip" data-placement="bottom" title="Add Salesrep"><i class="fas fa-marker"></i></button>';
