...
$(document).ready(function() {
    ...
    $("#editproduct").select2({
		...
		width: '100%',
		ajax: {
			url: "<?php echo base_url() ?>ServicePurchase/GetProductList",
			type: "post",
			dataType: 'json',
			delay: 250,
    	...
    	Swal.fire({
    		...
    		if (result.isConfirmed) {
    			...
    			$.ajax({
    				...
    				url: '<?php echo base_url() ?>ServicePurchase/Purchaseorderedit',
    ...
    $('#editbtncreateorder').click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "ServicePurchase/Purchaseorderupdate",
            data: orderData,
            success: function (result) {
    ...
    $('#edituom').change(function () {
        ...
        $.ajax({
            type: "POST",
            url: 'ServicePurchase/Getpiecesforqty',
            data: {
                recordID: uomID,
                productId: productId,
                qty: qty
    ...
    $('#editproduct').change(function () {
    	...
    	var supplier = $('#editsupplier').val();
    		...
    		$.ajax({
    			type: "POST",
    			url: 'ServicePurchase/Getproductinfoaccoproduct',
    			data: {
    				recordID: productID,
    				supplier: supplier 			
                },
