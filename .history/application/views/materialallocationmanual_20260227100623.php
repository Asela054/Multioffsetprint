...
$(document).ready(function () {
	...
	// delegate because rows are added dynamically
	$('#tableissue').on('click', '.btn-delete-row', function () {
		// remove the row that holds this button
		$(this).closest('tr').remove();

		// optional: if the table is now empty, disable the submit button
