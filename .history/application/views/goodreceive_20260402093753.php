...
<!-- Modal Update VAT Type -->
<div class="modal fade" id="updatevattypemodal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="staticBackdropLabel"><i class="fas fa-marker"></i> Update VAT Type</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <form id="updatevattypeform" autocomplete="off">
                            <div class="form-group mb-1">
                                <input type="hidden" class="form-control form-control-sm" id="hiddengrnid" name="hiddengrnid">
                            </div>
                            <div class="form-group mb-1">
                                <label class="small font-weight-bold text-dark">VAT Type*</label>
                                <select class("form-control form-control-sm") id("vattype") name("vattype") required>
                                    <option value="">Select VAT Type</option>
