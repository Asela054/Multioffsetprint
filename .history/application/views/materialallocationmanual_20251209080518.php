					...
					Swal.fire({
						...
						didOpen: () => {
							...
							success: function(result){
								...
								$.each(obj.batchlist, function(index, row){

									$('#tableissue > tbody:last').append(
										'<tr>' +
											'<td class="d-none">'+ $('#section').val() +'</td>' +
											'<td>'+ $("#section option:selected").text() +'</td>' +
											'<td class="text-center">'+ $('#issueqty').val() +'</td>' +
											'<td>'+ row.batchno +'</td>' +
											'<td class="d-none">'+ row.qty +'</td>' +
										'</tr>'
									);
								});
