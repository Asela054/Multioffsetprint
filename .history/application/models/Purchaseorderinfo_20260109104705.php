	...
	public function Purchaseorderview() {
		...
		<hr class="border-dark">
			...
			foreach($responddetail->result() as $roworderinfo) {
				...
				if ($roworderinfo->idtbl_material_group == 4 && $roworderinfo->tbl_material_id == 0) {
...
$this->db->select([
    ...
    'tbl_print_porder.tbl_supplier_idtbl_supplier',
    ...
    'tbl_print_porder_detail.tbl_measurements_idtbl_measurements',
    'tbl_print_porder_detail.tbl_material_id',

    // Supplier (only ID is needed)
