...
class MaterialallocationManualinfo extends CI_Model{
    ...
    public function DeleteManualIssue(){
        $this->db->trans_begin();
        ...
        // Update status to 3 in tbl_jobcard_manual_issue
        $data = array(
            'status' => 3,
            'tbl_user_idtbl_user' => $userID,
            'updatedatetime' => $updatedatetime
        );
        $this->db->where('idtbl_jobcard_manual_issue', $recordID);
        $this->db->update('tbl_jobcard_manual_issue', $data);

        // Update status to 3 in all related tables
        // tbl_jobcard_manual_issue_detail
        ...
        if ($this->db->trans_status() === TRUE) {
            ...
            $actionObj->icon = 'fas fa-trash-alt';
            $actionObj->title = '';
            $actionObj->message = 'Record Deleted Successfully';
            $actionObj->url = '';
            $actionObj->target = '_blank';
            $actionObj->type = 'danger';
