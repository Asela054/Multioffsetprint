...
public function IssueNoteView()
{
    ...
    <div class="row mb-2">
        <div class="col-6 small">
            <strong>Issue Date:</strong> ' . $header->issuedate . '<br>
            <strong>Location:</strong> ' . $header->location . '
        </div>
        <div class="col-6 small text-right">
            <strong>Employee:</strong> ' . $header->emp_fullname . '<br>
            <strong>Issue No:</strong> ' . $header->idtbl_print_issue . '
        </div>
    </div>
    ...
    foreach ($details as $row) {
        ...
        <tr>
            <td>' . $material . '</td>
            <td class="text-left">' . $row->measure_type . '</td>
            <td class="text-center">' . $row->qty . '</td>
            <td class="text-center">' . $row->stock_id . '</td>
    ...
    <table width="100%" class="mt-3">
        <tr>
            ...
            <td width="20%" class="text-right font-weight-bold">
                Rs. ' . number_format($header->total, 2) . '
            </td>
        </tr>
    </table>';
