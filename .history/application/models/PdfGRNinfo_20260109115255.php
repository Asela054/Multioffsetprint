...
class PdfGRNinfo extends CI_Model {
    public function pdfgrnget($x) {
        ...
        $this->db->select('tbl_print_grn.*, tbl_print_grndetail.*, tbl_print_grndetail.comment AS detail_comment, tbl_material_group.*'); 
    ...
    $itemDescription = $rowlist->detail_comment ?? '';
} else {
