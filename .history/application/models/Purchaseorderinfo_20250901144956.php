<?php class Purchaseorderinfo extends CI_Model {
	...
	public function Purchaseorderedit()
	{
		...
		$this->db->select('tbl_print_porder.*, tbl_print_porder_detail.*, tbl_supplier.*, $('#editbtncreateorder').click(function () {
...
.*, tbl_measurements.*, tbl_print_material_info.*, tbl_machine.*, tbl_service_type.*, tbl_spareparts.*, tbl_print_porder_detail.unitprice AS detail_unitprice');
		$this->db->from('tbl_print_porder');
		...
		$this->db->join('tbl_supplier', 'tbl_supplier.idtbl_supplier = tbl_print_porder.tbl_supplier_idtbl_supplier', 'left');
		$this->db->join('$('#editbtncreateorder').click(function () {
    $('#editbtncreateorder').prop('disabled', true).html(
        '<i class="fas fa-circle-notch fa-spin mr-2"></i> Create Order'
    );
...
.id$('#editbtncreateorder').click(function () {
    $('#editbtncreateorder').prop('disabled', true).html(
        '<i class="fas fa-circle-notch fa-spin mr-2"></i> Create Order'
    );
 ...
 = tbl_print_porder.tbl_material_group_idtbl_material_group', 'left');
		$this->db->join('tbl_measurements', 'tbl_measurements.idtbl_mesurements = tbl_print_porder_detail.tbl_measurements_idtbl_measurements', 'left');
		$this->db->join('tbl_print_material_info', 'tbl_print_material_info.idtbl_print_material_info = tbl_print_porder_detail.tbl_material_id', 'left');
		...
		$obj->type = $respond->row(0)->id$('#editbtncreateorder').click(function () {
    $('#editbtncreateorder').prop('disabled', true).html(
        '<i class="fas fa-circle-notch fa-spin mr-2"></i> Create Order'
    );
