            ...
            <header>
                <table style="width:100%;border-collapse: collapse;">
                    ...
                    <td width="55%" style="vertical-align: top;padding:0px;">
                        ...
                        '.($respond->row(0)->address_line1 ? '<p style="margin:0px;font-size:13px;padding-left: 24px;">'.$respond->row(0)->address_line1.',</p>' : '').'
                        '.($respond->row(0)->address_line2 ? '<p style="margin:0px;font-size:13px;padding-left: 24px;">'.$respond->row(0)->address_line2.',</p>' : '').'
                        '.($respond->row(0)->city ? '<p style="margin:0px;font-size:13px;padding-left: 24px;">'.$respond->row(0)->city.'.</p>' : '').'
                        '.($tpnumber != '&nbsp;' ? '<p style="margin:0px;font-size:13px;padding-left: 24px;">'.$tpnumber.'</p>' : '').'
