...
public function Purchaseorderedit()
{
    ...
    $this->db->select("
        tbl_print_porder.idtbl_print_porder,
        tbl_print_porder.tbl_print_porder_req_idtbl_print_porder_req,
        tbl_print_porder.orderdate,
        tbl_print_porder.tbl_material_group_idtbl_material_group,

        tbl_supplier.idtbl_supplier,
        ...
        tbl_measurements.idtbl_mesurements,
    ...
    $obj = new stdClass();
    $first = $respond->row();
    $obj->id = $first->idtbl_print_porder;
    $obj->requestid = $first->tbl_print_porder_req_idtbl_print_porder_req;
    $obj->orderdate = $first->orderdate;
    $obj->supplier = $first->idtbl_supplier;
    $obj->type = $first->tbl_material_group_idtbl_material_group;

    // Items
    $items = [];
    foreach ($respond->result() as $row) {
        if ($row->idtbl_print_material_info === null) continue;
