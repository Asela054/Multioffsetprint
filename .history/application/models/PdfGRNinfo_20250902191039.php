...
class PdfGRNinfo extends CI_Model {
    public function pdfgrnget($x) {
        ...
        foreach ($query->result() as $rowlist) {
            ...
            if ($rowlist->tbl_material_group_idtbl_material_group == 3) {
                $itemcode = $rowlist->materialinfocode;
                $itemdesc = $rowlist->materialname;
            } elseif ($rowlist->tbl_material_group_idtbl_material_group == 2) {
                $itemcode = '';
                $itemdesc = $rowlist->service_type;
            } elseif ($rowlist->tbl_material_group_idtbl_material_group == 4) {
                            ...
                            <td colspan="2" style="padding-top: 25px;">
                                <table style="width:100%;border-collapse: collapse;">
                                    ...
                                    foreach ($respondgrn->result() as $rowgrninfo) {                               
                                        if ($rowgrninfo->tbl_material_group_idtbl_material_group == 3) {
                                            $itemcode=$rowgrninfo->materialinfocode;
                                            $itemdesc=$rowgrninfo->materialname;
                                        }
                                        if ($rowgrninfo->tbl_material_group_idtbl_material_group == 2) {
                                            $itemcode='';
                                            $itemdesc=$rowgrninfo->service_type;
                                        }
                                        if ($rowgrninfo->tbl_material_group_idtbl_material_group == 4) {
