...
class Goodreceiverequestinfo extends CI_Model{
    ...
    public function Getproductaccosupplier(){
        ...
        $sql="SELECT `idtbl_print_material_info`, `materialinfocode`, `materialname` FROM `tbl_print_material_info` WHERE `tbl_company_idtbl_company`=$comapnyID AND `tbl_company_branch_idtbl_company_branch`=$branchID AND `status`=1 AND `tbl_material_group_idtbl_material_group`=? LIMIT 5";
