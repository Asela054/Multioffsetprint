...
class Invoiceinfo extends CI_Model{
    ...
    public function Invoiceinsertupdate(){
        ...
        if ($vat_customer == 1) {
            // build prefix for today's tax invoice numbers
            $taxDatePrefix = 'TXN' . date('Ymd', strtotime($date));

            // fetch the most recent tax_invoice_num for this company *and date* so
            // the sequence resets each day and always increments.
