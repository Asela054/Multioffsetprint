<?php class Goodreceiveinfo extends CI_Model {
	...
	public function Goodreceiveview() {
		...
		$this->db->select('tbl_print_grndetail.*,tbl_print_grn.invoice,tbl_print_grn.grndate,tbl_print_grn.grn_no,tbl_print_grn.tbl_material_group_idtbl_material_group, tbl_print_material_info.materialinfocode, tbl_print_material_info.materialname,tbl_measurements.measure_type');
