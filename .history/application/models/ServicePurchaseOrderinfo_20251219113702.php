<?php class ServicePurchaseOrderinfo extends CI_Model {
	...
	public function Purchaseorderedit()
	{
		...
		$this->db->select('tbl_print_porder.idtbl_print_porder, tbl_print_porder.idtbl_print_porder, tbl_print_porder_detail.*, tbl_supplier.*, tbl_material_group.*, tbl_measurements.*, tbl_print_material_info.*, tbl_print_porder_detail.unitprice AS detail_unitprice');
