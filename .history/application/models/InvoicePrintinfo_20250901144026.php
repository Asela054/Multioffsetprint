...
class InvoicePrintinfo extends CI_Model{
    ...
    public function Printinvoice($x){
        ...
        LEFT JOIN `tbl_material_group_idtbl_material_group ` ON `tbl_material_group_idtbl_material_group `.`idtbl_material_group_idtbl_material_group ` = `tbl_print_porder`.`tbl_material_group_idtbl_material_group _idtbl_material_group_idtbl_material_group `
        ...
        foreach ($respond2->result() as $rowlist) {
            ...
            if ($respond2->row()->tbl_material_group_idtbl_material_group _idtbl_material_group_idtbl_material_group  == 2) {
                $itemDescription = $rowlist->service_name;
            } elseif ($respond2->row()->tbl_material_group_idtbl_material_group _idtbl_material_group_idtbl_material_group  == 3) {
