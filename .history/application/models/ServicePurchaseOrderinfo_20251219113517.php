<?php class ServicePurchaseOrderinfo extends CI_Model {
	...
	public function Purchaseorderedit()
	{
		...
		$this->db->select('    tbl_print_porder.idtbl_print_porder,
    tbl_print_porder.tbl_print_porder_req_idtbl_print_porder_req AS requestid,
    tbl_print_porder.orderdate,
    tbl_print_porder.tbl_supplier_idtbl_supplier AS supplier_id,
    tbl_print_porder.tbl_material_group_idtbl_material_group AS material_group_id,
    ...
    tbl_measurements.idtbl_mesurements AS measureID,
    tbl_measurements.measure_type,

    tbl_print_material_info.idtbl_print_material_info AS materialID,
