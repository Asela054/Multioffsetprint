...
class Issuegoodreceiveinfo extends CI_Model{
    ...
    /**
     * Return JSON for a given item request including header and detail rows.
     */
    public function GetRequestDetails() {
        $recordID = $this->input->post('recordID');

        // header information: order type and employee
        ...
        // detail rows: item, measurement, qty, comment
