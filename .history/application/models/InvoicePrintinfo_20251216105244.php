...
<td width="55%" style="vertical-align: top;padding:0px;">
    ...
    <p style="margin:0px;font-size:13px;padding-left: 24px;">
        '.$respond->row(0)->address_line1.(!empty($respond->row(0)->address_line1) ? ',' : '').'
    </p>

    <p style="margin:0px;font-size:13px;padding-left: 24px;">
        '.$respond->row(0)->address_line2.(!empty($respond->row(0)->address_line2) ? ',' : '').'
    </p>

    <p style="margin:0px;font-size:13px;padding-left: 24px;">
        '.$respond->row(0)->city.(!empty($respond->row(0)->city) ? '.' : '').'
    </p>
