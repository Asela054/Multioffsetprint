...
class Creditnoteinfo extends CI_Model {
    ...
    public function GetCreditNoteDetails(){
        ...
        $this->db->select('cn.*, c.customer, c.contact, c.address1, c.address2, c.city, c.state');
        $this->db->from('tbl_credit_note cn');
        $this->db->join('tbl_customer c', 'c.idtbl_customer = cn.tbl_customer_idtbl_customer', 'left');
