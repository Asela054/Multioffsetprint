...
$columns = array(
	...
	array( 'db' => '`u`.`tbl_print_porder_idtbl_print_porder`', 'dt' => 'tbl_print_porder_idtbl_print_porder', 'field' => 'tbl_print_porder_idtbl_print_porder' )
);
...
$joinQuery = "FROM `tbl_print_grn` AS `u` LEFT JOIN `tbl_supplier` AS `ua` ON (`ua`.`idtbl_supplier` = `u`.`tbl_supplier_idtbl_supplier`) LEFT JOIN `tbl_location` AS `ub` ON (`ub`.`idtbl_location` = `u`.`tbl_location_idtbl_location`) LEFT JOIN `tbl_order_type` AS `uc` ON (`uc`.`idtbl_order_type` = `u`.`tbl_order_type_idtbl_order_type`)";
