...
// DB table to use
$table = 'tbl_direct_dispatch';

// Table's primary key
$primaryKey = 'idtbl_direct_dispatch';
...
// indexes
$columns = array(
	array( 'db' => '`u`.`idtbl_direct_dispatch`', 'dt' => 'idtbl_direct_dispatch', 'field' => 'idtbl_direct_dispatch' ),
	...
	array(
        'db' => "CONCAT(
            CASE 
                ...
                ELSE '<i class=\"fa fa-spinner text-warning mr-2\"></i>Pending Dispatch Note for Approval'
            END
        )",
...
$joinQuery = "FROM `tbl_direct_dispatch` AS `u`
