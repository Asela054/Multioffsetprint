...
// indexes
$columns = array(
	array( 'db' => '`u`.`idtbl_vehiclerenew_inquiry`', 'dt' => 'idtbl_vehiclerenew_inquiry', 'field' => 'idtbl_vehiclerenew_inquiry' ),
...
$joinQuery = "FROM `tbl_vehiclerenew_inquiry` AS `u` JOIN `tbl_vehicle` AS vehicle ON (`u`.`tbl_vehicle_idtbl_vehicle`=`vehicle`.`idtbl_vehicle`)
