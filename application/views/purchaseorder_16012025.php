				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-6">
							...
							<p style="margin-bottom: 2px; font-family: cursive;font-size:15px; font-weight: bold; padding-top: 8px;padding:0;"
								class="text-right" class="text-right"><span id="procode"></span>
							</P>
					...
					<div class="col-7 d-flex justify-content-end align-items-center gap-2">
                        <button type="button" name="approve" id="approve"
                            class="btn btn-success btn-m animated-button mr-2" title="Approve">
    ...
    $('#reject').click(function() {
        ...
        if (r == true) {
            ...
            $.ajax({
                ...
                url: 'Purchaseorder/Purchaseorderrejectstatus',
                success: function(result) { //alert(result);
                    var objfirst = JSON.parse(result);
                    $('#porderviewmodal').modal('hide');
                    // console.log(objfirst);
