    ...
    $('#dataTable').DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    var button = '';
                    button += '<button type="button" data-url="Purchaseorder/POmanualconfirm/' + full['idtbl_print_porder'] + '"  data-actiontype="6" class="btn btn-warning btn-sm mr-1 btntableaction"><i class="fas fa-clipboard-check"></i></button>';
                    button+='<button class="btn btn-primary btn-sm btnEdit mr-1 ';if(editcheck!=1){button+='d-none';}button+='" id="'+full['idtbl_print_porder']+'" ><i class="fas fa-pen"></i></button>';
