			...
			<div class="container-fluid">
				<div class="page-header-content py-3">
					<h1 class="page-header-title">
						...
						<span>Customer Inquiry For Approve</span>
					</h1>
				</div>
			</div>
		</div>
						...
						<div class="col-3">
							<form method="post" autocomplete="off" id="addjobform">
								...
								<div class="col-12">
									...
									<input type="text" class="form-control form-control-sm" name="ponumber" id="ponumber">
								</div>
								<div class="col-12">
...
<script>
    $(document).ready(function() {
        ...
        $('#tblcustomer').DataTable({
            ...
            "buttons": [
                { extend: 'csv', className: 'btn btn-success btn-sm', title: 'Customer Inquiry  For Approve  Information', text: '<i class="fas fa-file-csv mr-2"></i> CSV', },
                { extend: 'pdf', className: 'btn btn-danger btn-sm', title: 'Customer Inquiry  For Approve  Information', text: '<i class="fas fa-file-pdf mr-2"></i> PDF', },
                { 
                    extend: 'print', 
            ...
            ajax: {
                url: "<?php echo base_url() ?>scripts/customerinquaryapprovelist.php",
                ...
                },
				{
					...
					"render": function(data, type, row) {
						if (data == 1) {
							...
							return '<span class="text-danger font-weight-bold"><i class="fas fa-times-circle"></i> Inquiry Not Approved</span>';
						}
					}
				},
                {
                    ...
                    "render": function(data, type, full) {
						...
						if (full['approvestatus'] == 0) {
							button += '<a href="<?php echo base_url() ?>Customerinquiryforapprove/Customerinquiryapprovestatusapprove/' 
								+ full['idtbl_customerinquiry'] + '" onclick="return approve_confirm()" target="_self" class="btn btn-outline-info btn-sm mr-1">'
								+ '<i class="fas fa-exclamation-triangle"></i></a>';
						}
						if(full['status']==1){
                            button+='<a href="<?php echo base_url() ?>Customerinquiryforapprove/Customerinquiryapprovestatus/'+full['idtbl_customerinquiry']+'/2" onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-check"></i></a>';
                        }else{
                            button+='<a href="<?php echo base_url() ?>Customerinquiryforapprove/Customerinquiryapprovestatus/'+full['idtbl_customerinquiry']+'/1" onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-times"></i></a>';
                        }
                        button+='<a href="<?php echo base_url() ?>Customerinquiryforapprove/Customerinquiryapprovestatus/'+full['idtbl_customerinquiry']+'/3" onclick="return delete_confirm()" target="_self" class="btn btn-danger btn-sm ';if(deletecheck!=1){button+='d-none';}button+='"><i class="fas fa-trash-alt"></i></a>';
