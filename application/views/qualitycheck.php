            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        button+='<button class="btn btn-primary btn-sm btncheck mr-1" id="'+full['idtbl_print_grn']+'"><i class="fas fa-tasks"></i></button>';
                        }else{
                        button+='';
                        }
                        button+='<button class="btn btn-dark btn-sm btnview mr-1" id="'+full['idtbl_print_grn']+'"><i class="fas fa-eye"></i></button>';
                        // button+='<a href="<?php echo base_url() ?>Qualitycheck/Qualitycheckreport/'+full['idtbl_print_grn']+'" target="_self" class="btn btn-warning btn-sm mr-1"><i class="fas fa-file"></i></a>';
                        ...
                        button+='<a href="<?php echo base_url() ?>Qualitycheck/Qualitycheckstatus/'+full['idtbl_print_grn']+'/1" onclick="return active_confirm()" target="_self" class="btn btn-danger btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-times"></i></a>';
                        }
                        return button;
                    }
                }
