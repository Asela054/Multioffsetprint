				...
				<div class="container-fluid">
					<div class="page-header-content py-3">
						<h1 class="page-header-title">
							<div class="page-header-icon"><i class="fa fa-archive"></i></div>
...
<script>
	$(document).ready(function () {
		...
		$("#searchjobreport").submit(function (event) {
			...
			var table = $('#dataTable').DataTable({
				...
				"serverSide": true,
				ajax: {
					url: "<?php echo base_url() ?>scripts/jobreportlistreport.php",
					type: "POST",
					"data": function (d) {
						return $.extend({}, d, {
