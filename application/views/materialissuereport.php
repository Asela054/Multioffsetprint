				...
				<div class="container-fluid">
					<div class="page-header-content py-3">
						<h1 class="page-header-title">
							<div class="page-header-icon"><i class="fa fa-boxes"></i></div>
                            <span>&nbsp; Job Material Issue Report</span>
						</h1>
					</div>
				</div>
			</div>
			<div class="container-fluid mt-2 p-0 p-2">
				<div class="card">
					<div class="card-body p-0 p-2">
						<div class="col-12">
							<form id="searchmaterialissuereport">
								<div class="col-12">
									<div class="form-row">
										<div class="col-2">
										...
										<div class="col-2">
											...
											<input type="text" class="form-control form-control-sm" id="job" name="job" placeholder="Job number">
										</div>
										<div class="col-2"><br>
