    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="GRNView">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <p style="margin-bottom: 2px; font-family: cursive;font-size:15px; font-weight: bold; padding-top: 8px;padding:0;"
                            class="text-right" class="text-right"><span id="grncode"></span>
                        </P>
            ...
            <div class="modal-footer">
                <div class="col-12 text-right">
                    <hr>
                    <button id="btnapprovereject" class="btn btn-primary btn-sm px-3"><i
                            class="fas fa-check mr-2"></i>Approve or Reject</button>
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    if (full['approvestatus'] == 1) {
                        ...
                        return '<i class="fas fa-times text-danger mr-2"></i>Reject GRN';
                    }else {
                        return '<i class="fas fa-spinner text-warning mr-2"></i>Not Approved';
                    }
                }
            },
            {
                ...
                "render": function(data, type, full) {
                    ...
                    //         full['idtbl_print_grn'] +
                    //         '/3/' + full['tbl_print_porder_idtbl_print_porder'] +
