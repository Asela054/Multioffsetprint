				...
				<div class="container-fluid">
					<div class="page-header-content py-3">
						<h1 class="page-header-title font-weight-light">
							<div class="page-header-icon"><i class="fa fa-address-card"></i></div>
							<span><b>Vehicle Renew Inquiry For Approve</b></span>
						</h1>
					</div>
				</div>
			</div>
			<div class="container-fluid mt-2 p-0 p-2">
				<div class="card">
					<div class="card-body p-0 p-2">
						...
						<form id="addserviceform" action="<?php echo base_url() ?>Vehiclerenewforapprove/Vehiclerenewforapproveinsertupdate"
						...
						<div class="row">
							<div class="col-12">
								<div class="scrollbar pb-3" id="style-2">
									<table class="table table-bordered table-striped table-sm nowrap" id="tblvehiclerenew">
										<thead>
											<tr>
												<th>#</th>
	...
	$(document).ready(function () {
		...
		$('#tblvehiclerenew').DataTable({
			...
			"buttons": [{
					...
					title: 'Vehicle Renew Inquiry  Information',
			...
			ajax: {
				url: "<?php echo base_url() ?>scripts/vehiclerenewinquarylist.php",
			...
			"columns": [{
					"data": "idtbl_vehiclerenew_inquiry"
				},
				{
					"data": "vehicle_reg_no"
				},
...

				{
					...
					"render": function (data, type, full) {
						...
						button += '" id="' + full['idtbl_vehiclerenew_inquiry'] +
							'"><i class="fas fa-pen"></i></button>';
                            button +=
							'<a href="<?php echo base_url() ?>Vehiclerenewforapprove/Vehiclerenewforapprovestatusapprove/' +
							full['idtbl_vehiclerenew_inquiry'] +
						...
						if (full['status'] == 1) {
							button += '<a href="<?php echo base_url() ?>Vehiclerenewforapprove/Vehiclerenewforapprovestatus/' +
								full['idtbl_vehiclerenew_inquiry'] +
		...
		$('#tblvehiclerenew tbody').on('click', '.btnEdit', function () {
			...
			if (r == true) {
				...
				$.ajax({
					...
					url: '<?php echo base_url() ?>Vehiclerenewforapprove/Vehiclerenewforapproveedit',
