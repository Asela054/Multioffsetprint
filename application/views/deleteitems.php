                ...
                <div class="card">
                    <div class="card-body p-0 p-2">
                        <div class="col-12">
                            <form id="searchDeleteItems">
                                <div class="col-4">
                                    <div class="form-row mt-2">
                                        ...
                                        <div class="col-auto align-self-end">
                                            <div class="loading-indicator text-center" id="loadingIndicator" name="loadingIndicator" style="display: none;">
                            ...
                            <div class="col-12">
                                <div class="embed-responsive embed-responsive-16by9 w-100 responsive">
                                    <div class="embed-responsive-item responsive w-100" id="divFrame" src=""></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function(){
    ...
    $('#searchDeleteItems').submit(function(event){
        ...
        } else if (selectedValue === "4") { // PO
            loadView(divView, "<?php echo base_url() ?>Deleteitems/POView");
        } else {
            divView.empty(); 
        }
    });
