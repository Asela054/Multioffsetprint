...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <div class="collapse <?php if($functionmenu=="Goodreceive" | $functionmenu=="GRNVoucher" | $functionmenu=="Goodreceivereturn"){echo 'show';} ?>" id="collapsestores"
                ...
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Goodreceivereturn'; ?>">Good
                        Receive Note Return</a>
            ...
            <div class="collapse <?php if( $functionmenu=="Report" | $functionmenu=="Allstockview" | $functionmenu=="IssueMaterials" ){echo 'show';} ?>"
                ...
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark"
                        href="<?php echo base_url().'Allstockview'; ?>">All Stock View</a>
                    <?php }if(menucheck($menuprivilegearray, 149)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark"
                        href="<?php echo base_url().'IssueMaterials'; ?>">Issue Materials</a>
                    <?php } ?>
            ...
            <?php if(menucheck($menuprivilegearray,91)==1){ ?>
                        <a class="nav-link p-0 px-3 py-2 text-dark" href="<?php echo base_url().'Stocktransfer'; ?>">
                            <div class="nav-link-icon"><i class="fas fa-exchange-alt"></i></div>Stock Transfer
                        </a>
                        <?php } ?>
