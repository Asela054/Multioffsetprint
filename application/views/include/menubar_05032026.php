...
// }
// else if($functionmenu=='ServicePurchaseOrder'){
//     $addcheck=checkprivilege($menuprivilegearray, 180, 1);
//     $editcheck=checkprivilege($menuprivilegearray, 180, 2);
//     $statuscheck=checkprivilege($menuprivilegearray, 180, 3);
//     $deletecheck=checkprivilege($menuprivilegearray, 180, 4);
//     $approvecheck=checkprivilege($menuprivilegearray, 180, 5);
// }
// else if($functionmenu2=='Userroles'){
//     $addcheck=1;
//     $editcheck=1;
//     $statuscheck=1;
//     $deletecheck=1;
...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <?php } if(menucheck($menuprivilegearray, 87)==1 | menucheck($menuprivilegearray, 61)==1 | menucheck($menuprivilegearray, 180)==1){ ?>
            ...
            <div class="collapse <?php if($functionmenu=="Newpurchaserequest" | $functionmenu=="Purchaseorder" | $functionmenu=="ServicePurchaseOrder"){echo 'show';} ?>" id="collapseporder" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion">
                    ...
                    <?php } if(menucheck($menuprivilegearray, 180)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark"  href="<?php echo base_url().'ServicePurchaseOrder'; ?>">Service Purchase Order</a>
                    <?php } ?>
                </nav>
            </div>
            ...
            <div class="collapse <?php if($functionmenu2=="Useraccount" | $functionmenu2=="Usertype" | $functionmenu2=="Userprivilege"){echo 'show';} ?>"
                ...
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'User/Userpermissions'; ?>">User Permissions</a>
                    <?php } if(in_array("Userroles", $permissionallowed)){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'User/Userroles'; ?>">User Roles</a>
                    <?php } ?>
                </nav>
            </div>
            <?php } ?>
