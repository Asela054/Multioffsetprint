            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        if(editcheck==1){
                            button+='<button type="button" class="btn btn-primary btn-sm btnEdit mr-1" data-toggle="tooltip" data-placement="bottom" title="Edit" id="'+full['idtbl_location']+'"><i class="fas fa-pen"></i></button>';
                        }
                        if(full['status']==1 && statuscheck==1){
                            button+='<button type="button" data-url="Location/Locationstatus/'+full['idtbl_location']+'/2" data-actiontype="2" data-toggle="tooltip" data-placement="bottom" title="Active" class="btn btn-success btn-sm mr-1 btntableaction"><i class="fas fa-check"></i></button>';
                        }else if(full['status']==2 && statuscheck==1){
                            button+='<button type="button" data-url="Location/Locationstatus/'+full['idtbl_location']+'/1" data-actiontype="1" data-toggle="tooltip" data-placement="bottom" title="Deactive" class="btn btn-warning btn-sm mr-1 text-light btntableaction"><i class="fas fa-times"></i></button>';
                        }
                        if(deletecheck==1){
                            button+='<button type="button" data-url="Location/Locationstatus/'+full['idtbl_location']+'/3" data-actiontype="3" data-toggle="tooltip" data-placement="bottom" title="Delete" class="btn btn-danger btn-sm text-light btntableaction"><i class="fas fa-trash-alt"></i></button>';
                        }
