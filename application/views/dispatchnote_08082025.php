									...
									<div class="scrollbar pb-3" id="style-2">
										<table class="table table-bordered table-striped table-sm nowrap" id="dataTable">
											<thead>
												...
												<tr class="search-row">
													<th><input type="text" class="form-control form-control-sm" placeholder="Search Dispatch No" /></th>
													...
													<th><input type="text" class="form-control form-control-sm" placeholder="Search PO Num" /></th>
													<th><input type="text" class="form-control form-control-sm" placeholder="Search Job" /></th>
													<th><input type="text" class="form-control form-control-sm" placeholder="Search Job No" /></th>
													<th><input type="text" class="form-control form-control-sm" placeholder="Search Status" /></th>
													<th><input type="text" class="form-control form-control-sm" placeholder="Search Check By" /></th>
													<th></th>
												</tr>
												<tr>
													<th>Dispatch Number</th>
	...
	$('#dataTable').DataTable({
		...
		initComplete: function () {
			...
			this.api().columns().every(function () {
				var column = this;
				var searchInput = $('.search-row th:eq(' + column.index() + ') input');
    ...
    Swal.fire({
        ...
        didOpen: () => {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>Dispatchnote/Dispatchnotecheckstatus',
                success: function(result) {
                    Swal.close();
                    document.body.style.overflow = 'auto';
                    var obj = JSON.parse(result);
