...
class PlanDetails extends CI_Controller {
    ...
    public function GetDeliveryist(){
		$this->load->model('Plandetailsinfo');
        $result=$this->Plandetailsinfo->GetDeliveryist();
	}
    ...
    public function GetFinishQtyList(){
		$this->load->model('Plandetailsinfo');
        $result=$this->Plandetailsinfo->GetFinishQtyList();
	}
    public function GetAvailabilityOfItems(){
		$this->load->model('Plandetailsinfo');
        $result=$this->Plandetailsinfo->GetAvailabilityOfItems();
	}
    public function FinishDelivery(){
		$this->load->model('Plandetailsinfo');
        $result=$this->Plandetailsinfo->FinishDelivery();
	}
