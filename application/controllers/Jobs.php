...
class Jobs extends CI_Controller {
	...
	public function FetchPassedValue($x){
		...
		$result['boardList']=$this->Jobsinfo->GetBoardList();
		$result['colorList']=$this->Jobsinfo->GetColorList();
		$result['varnishList']=$this->Jobsinfo->GetVarnishList();
		$result['laminationList']=$this->Jobsinfo->GetLaminationList();
		$result['rimmingList']=$this->Jobsinfo->GetRimmingList();
		$result['platesList']=$this->Jobsinfo->GetPlatesList();
		$result['foilingList']=$this->Jobsinfo->GetFoilingList();
		$result['jobId']=$recordId;
