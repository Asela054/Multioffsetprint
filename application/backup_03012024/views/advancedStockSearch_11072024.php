        		...
        		<div class="container-fluid">
        			<div class="page-header-content py-3">
        				<h1 class="page-header-title font-weight-light">
        					...
        					<span><b>Advance Stock Report</b></span>
        				</h1>
        			</div>
        		</div>
        	</div>
                                ...
                                <div class="form-row">
                                        ...
                                        <div class="col-2">
                                            ...
                                            <select class="form-control form-control-sm selecter2 px-0" name="category" id="category" required>
                                                ...
                                                <option value="<?php echo $rowgetcategory->idtbl_material_type ?>"><?php echo $rowgetcategory->paper ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="col-2">
		...
		$("#searchStock").submit(function (event) {
			...
			var table = $('#dataTable').DataTable({
				...
				"columns": [
					...
					{
						"data": (selectedType == 2) ? "machine" : "materialname"
					},
					{
						"data": "batchno"
					},
				...
				footerCallback: function (row, data, start, end, display) {
                    ...
                    $(api.column(6).footer()).html('Rs. ' + pageTotalColumn3);
                },
