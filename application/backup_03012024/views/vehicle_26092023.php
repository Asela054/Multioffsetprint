            ...
            <div class="container-fluid mt-2 p-0 p-2">
                <div class="card">
                    <div class="card-body p-0 p-2">
						...
						<form action="<?php echo base_url() ?>Vehicle/Vehicleinsertupdate" method="post" autocomplete="off">
						 <div class="row">	
						  <div class="col-3">
								<div class="form-group mb-1">
									<label class="small font-weight-bold">Vehicle Reg NO*</label>
									<input type="text" class="form-control form-control-sm" name="vehicleregno" id="vehicleregno"
										required>
								</div>
							</div>
							<div class=" col-3 form-group">
								...
								<select class="form-control form-control-sm" name="vehicletype" id="vehicletype" required>
									...
									<option value="<?php echo $rowvehicletype->idtbl_vehicle_type  ?>"><?php echo $rowvehicletype->vehicle_type ?></option>
									<?php } ?>
								</select>
							</div>
                            <div class=" col-3 ">
								<label class="small font-weight-bold">Vehicle Brand*</label>
								<select class="form-control form-control-sm" name="vehiclebrand" id="vehiclebrand" required>
									<option value="">Select</option>
                            ...
                            <div class=" col-3 ">
								...
								<select class="form-control form-control-sm" name="vehiclemodel" id="vehiclemodel" required>
									<option value="">Select</option>
                         ...
                         <div class="row">
							<div class="col-3">
								<div class="form-group mb-1">
									...
									<input type="text" class="form-control form-control-sm" name="engineno" id="engineno"
										required>
								</div>
							</div>
							<div class="col-3">
...
<script>
    $(document).ready(function() {
        ...
        $('#dataTable').DataTable({
            ...
            "buttons": [
                { extend: 'csv', className: 'btn btn-success btn-sm', title: 'Vehicle  Information', text: '<i class="fas fa-file-csv mr-2"></i> CSV', },
                { extend: 'pdf', className: 'btn btn-danger btn-sm', title: 'Vehicle  Information', text: '<i class="fas fa-file-pdf mr-2"></i> PDF', },
                { 
                    extend: 'print', 
...
// console.log(currentyear,currentmonth,currentday,month,date)
            ...
            "columns": [
                ...
                //     },
                {
                    ...
                    "render": function(data, type, full) {
                        var button='';
						button+='<a href="<?php echo base_url() ?>Renewdetails/index/'+full['idtbl_vehicle']+'" target="_self" class="btn btn-secondary btn-sm mr-1"><i class="fas fa-file"></i></a>';
                        
						button+='<button class="btn btn-primary btn-sm btnEdit mr-1 ';if(editcheck!=1){button+='d-none';}button+='" id="'+full['idtbl_vehicle']+'"><i class="fas fa-pen"></i></button>';
                        if(full['status']==1){
                            button+='<a href="<?php echo base_url() ?>Vehicle/Vehiclestatus/'+full['idtbl_vehicle ']+'/2" onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-check"></i></a>';
                        }else{
                            button+='<a href="<?php echo base_url() ?>Vehicle/Vehiclestatus/'+full['idtbl_vehicle ']+'/1" onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-times"></i></a>';
                        }
                        button+='<a href="<?php echo base_url() ?>Vehicle/Vehiclestatus/'+full['idtbl_vehicle ']+'/3" onclick="return delete_confirm()" target="_self" class="btn btn-danger btn-sm ';if(deletecheck!=1){button+='d-none';}button+='"><i class="fas fa-trash-alt"></i></a>';
