                        		...
                        		<div class="form-row">
                        			<div class="col-2">
                        				...
                        				<select class="form-control form-control-sm" name="varnish" id="varnish" >
                        					...
                        					<option value="<?php echo $rowvarnishlist->idtbl_varnish ?>" <?php echo ($rowvarnishlist->idtbl_varnish == $quotationDetails['varnishDetails']['tbl_varnish_idtbl_varnish']) ? 'selected' : ''; ?>>
                        		...
                        		<div class="form-row">
                        			<div class="col-2">
                        				...
                        				<select class="form-control form-control-sm" name="lamination" id="lamination" >
                        					...
                        					<option value="<?php echo $rowlaminationlist->idtbl_lamination ?>" <?php echo ($rowlaminationlist->idtbl_lamination == $quotationDetails['laminationDetails']['tbl_lamination_idtbl_lamination']) ? 'selected' : ''; ?>>
