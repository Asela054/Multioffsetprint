				...
				<div class="container-fluid">
					<div class="page-header-content py-3">
						<h1 class="page-header-title">
							...
							<!-- <span><b>Vat Report</b></span> -->
                            <span>&nbsp;Canceled Invoice</span>
						</h1>
					</div>
				</div>
			</div>
	...
	$(document).ready(function () {
		...
		$("#searchvat").submit(function (event) {
			...
			var table = $('#dataTable').DataTable({
				...
				//scrollY: 350,
				ajax: {
					url: "<?php echo base_url() ?>scripts/cancelinvoicelist.php",
				...
				// },
				{
					...
					"render": function (data, type, full) {
						return (parseFloat(full['total']).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,'));
					}
				},
				],
				dom: 'Bfrtip',
				...
				footerCallback: function (row, data, start, end, display) {
					...
					$(api.column(3).footer()).html('Rs. ' + pageTotalColumn3);
				},
