...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <?php } if(menucheck($menuprivilegearray, 91)==1 | menucheck($menuprivilegearray, 92)==1 | menucheck($menuprivilegearray, 97)==1 | menucheck($menuprivilegearray, 98)==1 | menucheck($menuprivilegearray, 149)==1){ ?>
            <a class="nav-link p-0 px-3 py-2 collapsed text-dark" href="javascript:void(0);" data-toggle="collapse"
            ...
            <div class="collapse <?php if($functionmenu=="Stocktransfer" | $functionmenu=="Report" | $functionmenu=="AdvancedStockSearch" | $functionmenu=="IssueMaterials" ){echo 'show';} ?>"
