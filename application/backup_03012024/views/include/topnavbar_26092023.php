...
<a class="navbar-brand d-none d-sm-block" href="#"><i class="fas fa-star mr-2"></i>Multi DVMT</a><button class="btn btn-icon btn-transparent-dark order-1 order-lg-0 mr-lg-2" id="sidebarToggle" href="#"><i data-feather="menu"></i></button>
