                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                            <form id="createorderform" autocomplete="off">
                                                ...
                                                <div id="productFields">
                                                	<div class="form-group mb-1">
                                                		<label
                                                			class="small font-weight-bold text-dark">Spare Part/Service/Material/Machine*</label>
                                                		<input class="form-control form-control-sm" list="materials"
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 d-flex justify-content-end">
                                <button type="button" name="approve" id="approve" 
                                    class="btn btn-success btn-m mr-2 animated-button" title="Approve">
                                ...
                                <button type="button" name="reject" id="reject" 
                                    class="btn btn-danger btn-m animated-button" title="Reject">
                                    <i class="fas fa-times"></i>&nbsp;Reject
                                </button>
                                <input type="hidden" id="rejectbtn" name="rejectbtn">
                                <input type="text" id="statusid" name="statusid" hidden>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        materials.forEach(function(material) {
                            options += `<option value="${material.materialname}">`;
                        });
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    if (full['confirmstatus'] == 1) {
                        ...
                        return '<i class="fa fa-times text-danger mr-2"></i>Reject Order Request';
                    } else {
                        return '<i class="fa fa-times text-warning mr-2"></i>Not Confirm Order Request';
                    }
                }
            },

            {
                ...
                "render": function(data, type, full) {
                    ...
                    button += '<button class="btn btn-dark btn-sm btnview mr-1" id="' + full[
                            ...
                            'confirmstatus'] + '"><i class="fas fa-eye"></i></button>';
    ...
    $('#reject').click(function() {
        var r = confirm("Are you sure you want to reject this purchase order Request?");
        if (r == true) {
            let rejectbtn = $('#rejectbtn').val();
            $.ajax({
                type: "POST",
                data: {
                    rejectbtn: rejectbtn
                },
                url: 'Newpurchaserequest/Newpurchaserequestreject',
                success: function(result) { //alert(result);
                    var objfirst = JSON.parse(result);
                    $('#porderviewmodal').modal('hide');
                    // console.log(objfirst);
