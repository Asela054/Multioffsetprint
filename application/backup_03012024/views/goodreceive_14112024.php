                ...
                "render": function(data, type, full) {
                    ...
                    if (full['approvestatus'] == 1) {
                        ...
                        button +=
                            ...
                            '" onclick="return active_confirm()" target="_blank" class="btn btn-danger btn-sm mr-1 ';
                        if (statuscheck != 1) {
                            button += 'd-none';
                        }
                    ...
                    if (full['approvestatus'] == 0) {
                        button +=
                            ...
                            ' " onclick="return delete_confirm()" target="_blank" class="btn btn-danger btn-sm mr-1 ';
                        if (statuscheck != 1) {
                            button += 'd-none';
                        }
...
function finaltotalcalculate() {
    ...
    if (vatType === "1") {
        ...
        finaltotal = finalsubtot + vatamount;
    } else {
        $('#vatamount').val("0.00");
        finaltotal = finalsubtot;
    }
