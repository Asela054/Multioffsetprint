                                ...
                                <div class="form-row">
                                        ...
                                        <div class="col-2">
                                            ...
                                            <select class="form-control form-control-sm selecter2 px-0" name="supplier" id="supplier" required>
                                                ...
                                                <option value="<?php echo $rowgetsuppier->idtbl_supplier ?>"><?php echo $rowgetsuppier->name ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
    ...
    $(document).ready(function () {
		...
		$("#searchGrn").submit(function (event) {
			...
			var table = $('#dataTable').DataTable({
				...
				//scrollY: 350,
				ajax: {
					url: "<?php echo base_url() ?>scripts/advancegrnreportlist.php",
				...
				buttons: [{
					...
					},
					{
						...
						footer: true,
						title: 'MULTI OFFSET PRINTERS Grn Report - By Erav Technology'
					},
					{
						extend: 'csv',
					...
					},
					{
						...
						filename: 'Grn Report ' + typeName,
						footer: true,
						messageTop: 'Grn Report ' + typeName,
						customize: function (doc) {
							doc.styles.title = {
								color: 'black',
								fontSize: '30',
