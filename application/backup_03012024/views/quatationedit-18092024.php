                            ...
                            <div class="form-row">
                                ...
                                <div class="col-3">
                                    ...
                                    <select class="form-control form-control-sm" name="jobno" id="jobno" readonly>
                                     ...
                                     <option value="<?php echo $rowjobid->idtbl_customerinquiry_detail; ?>" <?php echo ($rowjobid->idtbl_customerinquiry_detail == $quotationDetails['quotation']['customer_jobno']) ? 'selected' : ''; ?>>
