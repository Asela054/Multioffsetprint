                                        ...
                                        <div class="form-row mb-1">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" name="uom" class="form-control form-control-sm"
                                                    id="uom" required readonly>
                                                <input type="text" name="uom_id" class="form-control form-control-sm"
                                                    id="uom_id" required readonly hidden>
                                            </div>
                                        </div>
                                    </div>
...
$(document).ready(function() {
    ...
    $('#sub_btn').on('click', function() {
        ...
        if (isCompanyDataChecked) {
                sessionStorage.setItem('cus_inquiry_company_id', company_id);
                sessionStorage.setItem('cus_inquiry_company_name', companyname);
                sessionStorage.setItem('cus_inquiry_branch_id', branch_id);
                sessionStorage.setItem('cus_inquiry_branch_name', branchname);
            } else {
                sessionStorage.removeItem('cus_inquiry_company_id');
                sessionStorage.removeItem('cus_inquiry_company_name');
                sessionStorage.removeItem('cus_inquiry_branch_id');
                sessionStorage.removeItem('cus_inquiry_branch_name');
            }
    ...
    $(document).on("click", "#BtnAdd", function() {
        if (!$("#addjobform")[0].checkValidity()) {
            ...
            $('#tbljoblist> tbody:last').append('<tr><td name="job">' +
                job + '</td><td class="text-center">' + qty +
