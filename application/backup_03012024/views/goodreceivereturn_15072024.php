                ...
                <div class="row">
                        ...
                        <form id="createorderform" autocomplete="off">
                            ...
                            <div class="form-row mb-1">
                                <div class="col">
                                    ...
                                    <select class="form-control form-control-sm selecter2 px-0" name="grn_no" id="grn_no" required>
                                        <option value="">Select</option>
                                    </select>
                                </div>
                                <div class="col">
                            ...
                            <div class="form-row mb-1">
                                <div class="col-9">
                                    ...
                                    <select class="form-control form-control-sm selecter2 px-0" name="product" id="product" required>
                                        <option value="">Select</option>
                                    </select>
                                </div>
								<div class="col-3">
                                    <label class="small font-weight-bold text-dark">Ordered Qty</label>
                                    <input type="text" id="orderedqty" name="orderedqty" class="form-control form-control-sm" readonly>
                                </div>
                            </div>
                            <div class="form-row mb-1">
                                <div class="col">
                                    ...
                                    <input type="text" id="returnqty" name="returnqty" class="form-control form-control-sm" <?php if($editcheck==0){echo 'readonly';} ?> required>
                                </div>
                                <div class="col">
                                    <label class="small font-weight-bold text-dark">UOM*</label>
                                    <select class="form-control form-control-sm" style="pointer-events: none;" name="uom" id="uom" readonly>
                                        <option value="">Select</option>
                            ...
                            <div class="form-row mb-1">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" id="unitdiscount" name="unitdiscount" class="form-control form-control-sm" <?php if($editcheck==0){echo 'readonly';} ?> value="0">
                                </div>
                            </div>
							<div class="form-row mb-1">
                                <div class="col">
                                    <label class="small font-weight-bold text-dark">Comment</label>
                                    <textarea id="comment" name="comment" class="form-control form-control-sm"></textarea>
                                </div>
                            </div>
                            <div class="form-group mb-1">
                                <label class="small font-weight-bold text-dark">Batch No</label>
                                <input type="text" id="batchno" name="batchno" class="form-control form-control-sm" required readonly>
                            </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <label class="small font-weight-bold text-dark">Discount*</label>
                                <input type="text" class="form-control form-control-sm" id="discount" value="0" onkeyup="finaltotalcalculate();" required>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="number" id="vat" name="vat" class="form-control form-control-sm" value="0" onkeyup="finaltotalcalculate();" required>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="form-group mt-2">
                            <button type="button" id="btncreateorder" class="btn btn-outline-primary btn-sm fa-pull-right"><i class="fas fa-save"></i>&nbsp;Create Good Receive return Note</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="GRNView">
                <div class="row">
                    ...
                    <div class="col-6">
                        <h2 style="margin-bottom: 2px; color: black;font-family: cursive;font-size:20px;font-weight: bold; padding:0;" class="text-right" class="text-right">Good Recieve Return Note<span id="pr"></span>
                        </h2>
                        <p style="margin-bottom: 2px; font-family: cursive;font-size:15px; font-weight: bold; padding-top: 8px;padding:0;" class="text-right" class="text-right">Multi Offset Printers (PVT) LTD <span id="proname"></span>
                        </p>
                        <p style="margin-bottom: 2px; font-family: cursive;font-size:15px; font-weight: bold; padding-top: 8px;padding:0;" class="text-right" class="text-right">MO/GRN-0000<span id="grncode"></span>
                        </P>
                    </div>
                </div>
                <div id="viewhtml"></div>
            ...
            <div class="modal-footer">
                <button type="button" id="printgrn" class="btn btn-outline-primary btn-sm fa-pull-right"
                    <?php if($addcheck==0){echo 'disabled';} ?>><i class="far fa-save"></i>&nbsp;Print GRN Return</button>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    ...
                    button += '<button class="btn btn-dark btn-sm btnview mr-1" id="' + full['idtbl_print_grn_return'] + '" data-grnid="'+full['grn_no']+'" data-toggle="tooltip" data-placement="top" title="View"><i class="fas fa-eye"></i></button>';
                    if (full['approvestatus'] == 1) {
                        ...
                        button +=
                            '<a href="<?php echo base_url() ?>Goodreceivereturn/Goodreceivereturnstatus/' + full['idtbl_print_grn_return'] + '/1" onclick="return active_confirm()" target="_self" class="btn btn-danger btn-sm mr-1 ';
                        if (statuscheck != 1) {
                            button += 'd-none';
                        }
                        button += '" data-toggle="tooltip" data-placement="top" title="Approved"><i class="fas fa-times"></i></a>';
                    }
                    if (full['approvestatus'] == 0) {
                        button +=
                            '<a href="<?php echo base_url() ?>Goodreceivereturn/Goodreceivereturnstatus/' + full['idtbl_print_grn_return'] + '/3" onclick="return delete_confirm()" target="_self" class="btn btn-danger btn-sm mr-1 ';
                        if (statuscheck != 1) {
                            button += 'd-none';
                        }
                        button += '" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fas fa-trash-alt"></i></a>';
                    }
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $.each(obj, function(i, item) {
                    html1 += '<option value="' + obj[i].idtbl_print_grn + '">' + 'GRN000' + obj[i].idtbl_print_grn + '</option>';
	...
	$("#formsubmit").click(function() {
        if (!$("#createorderform")[0].checkValidity()) {
			...
			'</td><td>' + comment + '<td class="text-right"> ' + showtotal + '</td><td class="d-none total"> ' + total +
