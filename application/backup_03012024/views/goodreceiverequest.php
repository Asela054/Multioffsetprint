										...
										<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
											<form id="createorderform" autocomplete="off">
												...
												<div class="form-row mb-1">
													...
													<!-- <div class="col">
														<label class="small font-weight-bold text-dark">Unit Price /
															Amount</label>
		...
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- <h2 style="margin-bottom: 2px;" class="text-right">Internal Item Request<span id="pr"></span>
					</h2>
					<p style="margin-bottom: 2px;" class="text-right">MO/IR-0000<span id="procode"></span></P> -->
		...
		$('#ordertype').change(function () {
			...
			if (ordertype == 3) {
				$.ajax({
					...
					url: 'Goodreceiverequest/Getproductaccosupplier',
					success: function (result) {
						var obj = JSON.parse(result);
						var html1 = '';
						html1 += '<option value="">Select</option>';
				...
				$.ajax({
					...
					url: 'Goodreceiverequest/Getproductformachine',
					success: function (result) {
						var obj = JSON.parse(result);
						var html1 = '';
						html1 += '<option value="">Select</option>';
