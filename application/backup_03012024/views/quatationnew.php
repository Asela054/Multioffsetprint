        		...
        		<div class="container-fluid">
        			<div class="page-header-content py-3">
        				<h1 class="page-header-title font-weight-light">
        					...
        					<span><b> New Customer Job Quatation</b></span>
        				</h1>
        			</div>
        		</div>
        	</div>
                        ...
                        <div class="12">
                            <div class="form-row">
                                ...
                                <div class="col-3">
                                    ...
                                    <select class="form-control form-control-sm" name="customerjob" id="customerjob" required>
                                        <option value="">Select</option>
                                    </select>
                                </div>
                                <div class="col-3">
                                    <label class="small font-weight-bold">Job No*</label>
                                    <select class="form-control form-control-sm" name="jobno" id="jobno" required>
                                        <option value="">Select</option>
                                    </select>
                                </div>
                                <div class="col-3">
                                    <lable class="font-weight-bold small">Quantity*</lable>
                                    <input type="number" name="quantity" id="quantity" class="form-control form-control-sm mt-2">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                    ...
                                    <div class="col-2">
                        				...
                        				<input type="number" name="wastageboard" id="wastageboard"
                        					class="form-control form-control-sm mt-2" step="any">
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			<div class="col-6">
                        				...
                        				<div class="row">
                        					<div class="col-6">
                        						<input type="number" name="cutsize3" id="cutsize3" step="any"
                        							class="form-control form-control-sm mt-2">
                        					</div>
                        					<div class="col-6">
                        						<input type="number" name="cutsize4" id="cutsize4" step="any"
                        							class="form-control form-control-sm mt-2">
                        					</div>
                        				</div>
                        			</div>
                        			<div class="col-3">
                        				...
                        				<input type="number" name="cutssheetsper" id="cutssheetsper" step="any"
                        					class="form-control form-control-sm mt-2">
                        			</div>
                        			<div class="col-3">
                        				<lable class="font-weight-bold small">No Of Ups*</lable>
                        				<input type="number" name="noofups" id="noofups" step="any"
                        					class="form-control form-control-sm mt-2">
                        			</div>
                        		</div>
                        </div>
                        ...
                        <hr style=" border: 2; height: 1px; background: #333; width: 100%;">
                        	...
                        	<div class="col-12">
                        		<div class="form-row">
                        			...
                        			<div class="col-2">
                        				...
                        				<select class="form-control form-control-sm" name="boardpaperbatch"
                        					id="boardpaperbatch">
                        					<option value="">Select</option>
                        				</select>
                        			</div>
                        			...
                        			<div class="col-2">
                        				...
                        				<input type="number" name="board_quantity2" id="board_quantity2" step="any"
                        					class="form-control form-control-sm" oninput="calmaterialtotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="board_total" id="board_total" step="any"
                        		...
                        		<div class="form-row">
                        			<div class="col-4">
                        				...
                        				<input type="number" name="wastagelist" id="wastagelist" step="any"
                        					class="form-control form-control-sm" oninput="calwastagetotal()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Cal 1*</label>
                        				<input type="number" name="wastage_cal1" id="wastage_cal1" step="any"
                        					class="form-control form-control-sm">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Cal 2 *</label>
                        				<input type="number" name="wastage_cal2" id="wastage_cal2" step="any"
                        					class="form-control form-control-sm">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="wastage_total" id="wastage_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		...
                        		<div class="form-row">
                        			<div class="col-3">
                        				...
                        				<select class="form-control form-control-sm" name="colors" id="colors">
                        					...
                        					<option value="<?php echo $rowcolorlist->idtbl_color ?>">
                        						<?php echo $rowcolorlist->color ?></option> <?php } ?>
                        				</select>
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Batch*</label>
                        			...
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Unit Price*</label>
                        				<input type="number" name="colors_unitprice" id="colors_unitprice" step="any"
                        					class="form-control form-control-sm" oninput="calcolortotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">QTY*</label>
                        				<input type="number" name="colors_quantity" id="colors_quantity" step="any"
                        					class="form-control form-control-sm" oninput="calcolortotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="colors_total" id="colors_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		...
                        		<div class="form-row">
                        			<div class="col-2">
                        				...
                        				<select class="form-control form-control-sm" name="varnish" id="varnish" >
                        					...
                        					<option value="<?php echo $rowvarnishlist->idtbl_print_material_info ?>">
                        			...
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Unit Price*</label>
                        				<input type="number" name="varnish_unitprice" id="varnish_unitprice" step="any"
                        					class="form-control form-control-sm" oninput="calvarnishtotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Width*</label>
                        				<input type="number" name="varnish_quantity" id="varnish_quantity" step="any"
                        					class="form-control form-control-sm" oninput="calvarnishtotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Height*</label>
                        				<input type="number" name="varnish_quantity2" id="varnish_quantity2" step="any"
                        					class="form-control form-control-sm" oninput="calvarnishtotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label> 
                        				<input type="number" name="varnish_total" id="varnish_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		...
                        		<div class="form-row">
                        			<div class="col-2">
                        				...
                        				<select class="form-control form-control-sm" name="lamination" id="lamination" >
                        					...
                        					<option value="<?php echo $rowlaminationlist->idtbl_print_material_info ?>">
                        			...
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Unit Price*</label>
                        				<input type="number" name="lamination_unitprice" id="lamination_unitprice" step="any"
                        					class="form-control form-control-sm" oninput="callaminationtotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Width*</label>
                        				<input type="number" name="lamination_quantity" id="lamination_quantity" step="any"
                        					class="form-control form-control-sm" oninput="callaminationtotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Height*</label>
                        				<input type="number" name="lamination_quantity2" id="lamination_quantity2" step="any"
                        					class="form-control form-control-sm" oninput="callaminationtotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="lamination_total" id="lamination_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		...
                        		<div class="form-row">
                        			...
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Unit Price*</label>
                        				<input type="number" name="foiling_unitprice" id="foiling_unitprice" step="any"
                        					class="form-control form-control-sm" oninput="calfoldingtotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Width*</label>
                        				<input type="number" name="foiling_quantity" id="foiling_quantity" step="any"
                        					class="form-control form-control-sm" oninput="calfoldingtotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Height*</label>
                        				<input type="number" name="foiling_quantity2" id="foiling_quantity2" step="any"
                        					class="form-control form-control-sm" oninput="calfoldingtotal()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label> 
                        				<input type="number" name="foiling_total" id="foiling_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			...
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Unit Price*</label>
                        				<input type="number" name="rimming_unitprice" id="rimming_unitprice" step="any"
                        					class="form-control form-control-sm" oninput="calrimming()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">QTY*</label>
                        				<input type="number" name="rimming_quantity" id="rimming_quantity" step="any"
                        					class="form-control form-control-sm" oninput="calrimming()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="rimming_total" id="rimming_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			...
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Unit Price*</label>
                        				<input type="number" name="cutting_unitprice" id="cutting_unitprice" step="any"
                        					class="form-control form-control-sm" oninput="calcutting()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">QTY*</label>
                        				<input type="number" name="cutting_quantity" id="cutting_quantity" step="any"
                        					class="form-control form-control-sm" oninput="calcutting()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="cutting_total" id="cutting_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			...
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Unit Price*</label>
                        				<input type="number" name="pasting_unitprice" id="pasting_unitprice" step="any"
                        					class="form-control form-control-sm" oninput="calpasting()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">QTY*</label>
                        				<input type="number" name="pasting_quantity" id="pasting_quantity" step="any"
                        					class="form-control form-control-sm" oninput="calpasting()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="pasting_total" id="pasting_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			<div class="col-3">
                        				...
                        				<input type="number" name="filmchage_unitprice" id="filmchage_unitprice" step="any"
                        					class="form-control form-control-sm" oninput="calfilmcharge()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Width*</label>
                        				<input type="number" name="filmchage_quantity" id="filmchage_quantity" step="any"
                        					class="form-control form-control-sm" oninput="calfilmcharge()">
                        			</div>
                        			<div class="col-4">
                        				<label class="small font-weight-bold">Height*</label>
                        				<input type="number" name="filmchage_quantity2" id="filmchage_quantity2" step="any"
                        					class="form-control form-control-sm" oninput="calfilmcharge()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label> 
                        				<input type="number" name="filmchage_total" id="filmchage_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			<div class="col-3">
                        				...
                        				<select class="form-control form-control-sm" name="plates" id="plates">
                        					...
                        					<option value="<?php echo $rowplatelist->idtbl_plates ?>">
                        			...
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Unit Price*</label>
                        				<input type="number" name="plates_unitprice" id="plates_unitprice" step="any"
                        					class="form-control form-control-sm" oninput="calplate()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">QTY*</label>
                        				<input type="number" name="plates_quantity" id="plates_quantity" step="any"
                        					class="form-control form-control-sm" oninput="calplate()">
                        			</div>
                        			<div class="col-2">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="plates_total" id="plates_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			<div class="col-3">
                        				...
                        				<input type="number" name="embosing_price" id="embosing_price" step="any"
                        					class="form-control form-control-sm" oninput="calembosingblock()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="embosing_total" id="embosing_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                                    <div class="col-3">
                        				<label class="small font-weight-bold">Foiling Blocks*</label>
                        				<input type="number" name="foilingblock_price" id="foilingblock_price" step="any"
                        					class="form-control form-control-sm" oninput="calfoilingblock()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="foilingblock_total" id="foilingblock_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			<div class="col-3">
                        				...
                        				<input type="number" name="cutter_price" id="cutter_price" step="any"
                        					class="form-control form-control-sm" oninput="calcutter()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="cutter_total" id="cutter_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                                    <div class="col-3">
                        				<label class="small font-weight-bold">Window Pasting*</label>
                        				<input type="number" name="windowpasting_price" id="windowpasting_price" step="any"
                        					class="form-control form-control-sm" oninput="windowpasting()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="windowpasting_total" id="windowpasting_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			<div class="col-3">
                        				...
                        				<input type="number" name="WindowpatchFilm_price" id="WindowpatchFilm_price" step="any"
                        					class="form-control form-control-sm" oninput="windowpatchfilm()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">width*</label>
                        				<input type="number" name="Windowpatch_width" id="Windowpatch_width" step="any"
                        					class="form-control form-control-sm" oninput="windowpatchfilm()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">height*</label>
                        				<input type="number" name="Windowpatch_height" id="Windowpatch_height" step="any"
                        					class="form-control form-control-sm" oninput="windowpatchfilm()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="Windowpatch_total" id="Windowpatch_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			<div class="col-3">
                        				...
                        				<input type="number" name="boardlamination_price" id="boardlamination_price" step="any"
                        					class="form-control form-control-sm" oninput="boardlamination()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">width*</label>
                        				<input type="number" name="boardlamination_width" id="boardlamination_width" step="any"
                        					class="form-control form-control-sm" oninput="boardlamination()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">height*</label>
                        				<input type="number" name="boardlamination_height" id="boardlamination_height" step="any"
                        					class="form-control form-control-sm" oninput="boardlamination()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="boardlamination_total" id="boardlamination_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        		<div class="form-row">
                        			<div class="col-3">
                        				...
                        				<input type="number" name="transport" id="transport" step="any"
                        					class="form-control form-control-sm" oninput="caltransport()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="transport_total" id="transport_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Commision*</label>
                        				<input type="number" name="commision" id="commision" step="any"
                        					class="form-control form-control-sm" oninput="calcommision()">
                        			</div>
                        			<div class="col-3">
                        				<label class="small font-weight-bold">Total *</label>
                        				<input type="number" name="commision_total" id="commision_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                                <hr style=" border: 2; height: 1px; background: #333; width: 100%;">
                        		<div class="form-row">
                        			...
                        			<div class="col-3">
                        				...
                        				<input type="number" name="net_total" id="net_total" step="any"
                        					class="form-control form-control-sm" readonly>
                        			</div>
                        		</div>
                        	</div>
                           <div class="form-row">
                                <div class="col-4">
                                    ...
                                    <input type="number" name="margin" id="margin" class="form-control form-control-sm" step="any" oninput="margincal()"> 
                                </div>
                                <div class="col-4">
                                    <label class="small font-weight-bold">Margin Calculation*</label>
                                    <input type="number" step="any" name="margincalculation" id="margincalculation" step="any"
                                        class="form-control form-control-sm"  readonly>
                                </div>
                                <div class="col-4">
                                    <label class="small font-weight-bold">Total with Margin*</label>
                                    <input type="number" step="any" name="totalmargin" id="totalmargin" step="any"
                                        class="form-control form-control-sm" readonly>
                                </div>
                           </div>
                           <div class="form-row">
                                <div class="col-3">
                                    ...
                                    <input type="number" name="calvalue" id="calvalue" class="form-control form-control-sm" step="any" readonly>
                                </div>
                                <div class="col-3">
                                    <label class="small font-weight-bold">Credit*</label>
                                    <input type="number" step="any" name="credit" id="credit" step="any"
                                        class="form-control form-control-sm" oninput="creditcal()">
                                </div>
                                <div class="col-3">
                                    <label class="small font-weight-bold">Credit Total*</label>
                                    <input type="number" step="any" name="credittotal" id="credittotal" step="any"
                                        class="form-control form-control-sm" readonly>
                                </div>
                                <div class="col-3">
                                    <label class="small font-weight-bold">Total*</label>
                                    <input type="number" step="any" name="creditwithtotal" id="creditwithtotal" step="any"
                                        class="form-control form-control-sm" readonly>
                                </div>
                           </div>
                           <div class="form-row">
                                <!-- <div class="col-3">
									...
									<input type="number" name="vat2" id="vat2" class="form-control form-control-sm" step="any">
                                   
                                </div> -->
                                <div class="col-4">
                                    <label class="small font-weight-bold">VAT %</label>
									<input type="number" name="vat" id="vat" class="form-control form-control-sm" step="any" oninput="creditvat()">
                                </div>
                                <div class="col-5">
                                    <label class="small font-weight-bold">VAT Count*</label>
                                    <input type="number" step="any" name="vatcount" id="vatcount" class="form-control form-control-sm" step="any" readonly>
                                </div>
                                <div class="col-3">
                                    <label class="small font-weight-bold">Total with VAT*</label>
                                    <input type="number" step="any" name="tptalwithvat" id="tptalwithvat" class="form-control form-control-sm" step="any" readonly>
                                </div>
                           </div>
                                <hr style=" border: 2; height: 1px; background: #333; width: 100%;">
...
<script>
    $(document).ready(function() {
     	...
     	if (job_id != '') {
     		$.ajax({
     			...
     			success: function (data) {
     				var options = '<option value="">Select</option>';
     				$.each(data, function (index, job) {
     					options += '<option value="' + job.job_id + '" data-qty="' + job.qty + '">' + job.job_no + '</option>';
     				});
     				$('#jobno').html(options);
     			}
     		});
     ...
     $('#jobno').change(function () {
     	...
     	if (JobID != '') {
     		$.ajax({
     			url: "<?php echo base_url('Quatation/getjobinstruction'); ?>",
     			type: "POST",
     			data: {
     				JobID: JobID
     			},
     			success: function (result) 
                {
                    var obj = JSON.parse(result);
                        $('#boardpaper').val(obj.idtbl_print_material_info);
					 	$('#printformat').val(obj.idtbl_printing_format);
						$('#cutsize1').val(obj.cutsize_W);
					    $('#cutsize2').val(obj.cutsize_H);
                        $('#noofups').val(obj.no_of_ups);
					 	$('#boardpaperselect').val(obj.idtbl_print_material_info);
						$('#colors').val(obj.idtbl_print_color);
					    $('#varnish').val(obj.idtbl_varnish);
                        $('#lamination').val(obj.idtbl_lamination);
					 	$('#foiling').val(obj.idtbl_foiling);
						$('#rimming').val(obj.idtbl_rimming);
					    $('#cutting').val(obj.idtbl_diecutting);
                        $('#pasting').val(obj.idtbl_pasting);
					 	//$('#plates').val(obj.idtbl_printing_format);
     			}
     		});
     	}
     });
	...
	// get qty for that job no
	$('#jobno').change(function () {
		var qty = $('#jobno option:selected').data('qty');
		$('#quantity').val(qty);
	});
