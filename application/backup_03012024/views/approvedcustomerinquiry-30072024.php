									...
									<div class="col-12">
										<div class="form-group mt-2">
											<input type="hidden" name="hiddenjobdetailsid" id="hiddenjobdetailsid"
												value="1">
											<input type="hidden" name="hiddenallocatedmaterial" id="hiddenallocatedmaterial"
												value="0">
				...
				success: function (result) {
					...
					$.each(obj, function (i, item) {
						...
						$('#tblmateriallist> tbody:last').append(
							...
							'</td><td><button type="button" id="'+ obj[i].idtbl_inquiry_allocated_materials +'" class=" btn btn-primary btn-sm float-right btnEditMaterials"><i class="fa fa-pen"></i></button></td><td class="d-none">' + obj[i]
							.idtbl_print_material_info +
							'</td><td class="d-none">' + obj[i].tbl_material_type_idtbl_material_type  +
							'</td><td class="d-none">' + obj[i].tbl_categorygauge_idtbl_categorygauge  +
							'</td><td class="d-none materialtotal">' + sum +
							'</td><td class="d-none">' + obj[i].unitprice +
							'</td><td class="d-none">2</td><td class="d-none">'+ obj[i].idtbl_inquiry_allocated_materials +'</td></tr>');
		...
		$('#BtnAddMaterial').on('click', function () {
			if (!$("#addjobmaterialform")[0].checkValidity()) {
				...
				$('#tblmateriallist> tbody:last').append('<tr><td class="text-center">' + materialtext +
					...
					showsum + '</td><td><button type="button" id="btnEditrowMaterial" class=" btn btn-primary btn-sm float-right btnEditMaterials" disabled><i class="fa fa-pen"></i></button></td><td class="d-none">' + modalmaterial +
					'</td><td class="d-none">' + materialtype +
					'</td><td class="d-none">' + gaugetype +
					'</td><td class="d-none materialtotal">' + sum +
					'</td><td class="d-none">' + materialunitprice +
					'</td><td class="d-none">' + edited + '</td><td class="d-none">'+ hiddenallocatedmaterial +'</td></tr>');
