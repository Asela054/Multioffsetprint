								...
								<form action="<?php echo base_url() ?>Materialdetail/Materialdetailinsertupdate"
										...
										<div class="col">
											...
											<select class="form-control form-control-sm" name="material_color"
												...
												<option value="<?php echo $rowmaterialcolor->idtbl_color ?>">
													<?php echo $rowmaterialcolor->name ?>
												</option>
												<?php } ?>
											</select>
										</div>
									...
									<div class="col">
											...
											<select class="form-control form-control-sm" name="material_categorygauge"
												...
												<option value="<?php echo $rowmaterialcategorygauge->idtbl_categorygauge ?>">
...
<script>
	$(document).ready(function () {
		...
		function updateMaterialName() {
			...
			var materialCategory = $('#materialcategory option:selected').text().trim();
			var materialColor = $('#material_color option:selected').text().trim();
			var materialCategoryGauge = $('#material_categorygauge option:selected').text().trim();

			var concatenatedValue = materialCategory + ' ' + materialColor + ' ' + materialCategoryGauge;
