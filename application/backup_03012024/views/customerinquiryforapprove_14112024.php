            ...
            "columns": [
				...
				
                {
                    ...
                    "render": function(data, type, full) {
						...
						button+='<a href="<?php echo base_url() ?>Customerinquiryforapprove/Customerinquiryapprovestatusapprove/'+full['idtbl_customerinquiry']+'" onclick="return approve_confirm()" target="_self" class="btn btn-outline-info btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-exclamation-triangle"></i></a>';
						if(full['status']==1){
