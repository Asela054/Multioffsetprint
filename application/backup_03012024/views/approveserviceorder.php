				...
				<div class="container-fluid">
					<div class="page-header-content py-3">
						<h1 class="page-header-title font-weight-light">
							...
							<span><b>Approved Service Order Inquiry</b></span>
						</h1>
					</div>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-12">
								<div class="scrollbar pb-3" id="style-2">
									<table class="table table-bordered table-striped table-sm nowrap" id="tblserviceorder">
										<thead>
											<tr>
												<th>#</th>
	...
	$(document).ready(function () {
		...
		$('#tblserviceorder').DataTable({
			...
			"buttons": [{
					...
					title: 'Approved Service Order Inquiry Information',
			...
			ajax: {
				url: "<?php echo base_url() ?>scripts/approvedserviceinquarylist.php",
			...
			"columns": [
...

				{
					...
					"render": function (data, type, full) {
						...
						if (full['status'] == 1) {
							button += '<a href="<?php echo base_url() ?>Approveserviceorder/Approveserviceorderstatus/' +
