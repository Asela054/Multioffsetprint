                        ...
                        <div class="row">
                            <div class="col-3">
								...
								<div class="form-group">
                                        <label class="small font-weight-bold">Machine Factory *</label>
								...
								<div class="form-group mb-1">
									...
									<div class="form-group mb-1">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="boardsize" id="boardsize" required>
                                    </div>
