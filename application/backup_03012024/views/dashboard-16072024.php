...
//Material
$sql = "SELECT COUNT(`idtbl_print_stock`) AS stockcount FROM `tbl_print_stock` LEFT JOIN `tbl_print_material_info` ON `tbl_print_material_info`.`idtbl_print_material_info`= `tbl_print_stock`.`tbl_print_material_info_idtbl_print_material_info` WHERE `tbl_print_stock`.`status` = 1 AND `tbl_print_stock`.`tbl_print_material_info_idtbl_print_material_info`";
$materialinfo=$this->db->query($sql);

//Matchine
$sql = "SELECT COUNT(`idtbl_print_stock`) AS stockcount FROM `tbl_print_stock` LEFT JOIN `tbl_machine` ON `tbl_machine`.`idtbl_machine`= `tbl_print_stock`.`tbl_machine_id` WHERE `tbl_print_stock`.`status` = 1 AND `tbl_print_stock`.`tbl_machine_id`";
$machineinfo=$this->db->query($sql);

//Spare Parts
$sql = "SELECT COUNT(`idtbl_print_stock`) AS stockcount FROM `tbl_print_stock` LEFT JOIN `tbl_spareparts` ON `tbl_spareparts`.`idtbl_spareparts`= `tbl_print_stock`.`tbl_sparepart_id` WHERE `tbl_print_stock`.`status` = 1 AND `tbl_print_stock`.`tbl_sparepart_id`";
$sparepartinfo=$this->db->query($sql);

//Zero Stock
$sql = "SELECT COUNT(`idtbl_print_stock`) AS stockcount FROM `tbl_print_stock` LEFT JOIN `tbl_print_material_info` ON `tbl_print_material_info`.`idtbl_print_material_info`= `tbl_print_stock`.`tbl_print_material_info_idtbl_print_material_info` WHERE `tbl_print_stock`.`status` = 1 AND `tbl_print_stock`.`qty` = 0 AND `tbl_print_stock`.`tbl_print_material_info_idtbl_print_material_info`";
$zerostockinfo=$this->db->query($sql);


// Last 5 Purchase
$sql="SELECT m.materialname, g.date, g.qty, g.unitprice, g.total FROM tbl_print_grndetail g INNER JOIN tbl_print_material_info m ON g.tbl_print_material_info_idtbl_print_material_info = m.idtbl_print_material_info WHERE g.status = 1 AND g.tbl_print_material_info_idtbl_print_material_info <> 0 ORDER BY g.date DESC LIMIT 5 ";
$resultdate = $this->db->query($sql);

// Top Five Purchase Report
$sql="SELECT m.materialname, g.date, g.qty, g.unitprice, g.total FROM tbl_print_grndetail g INNER JOIN tbl_print_material_info m ON g.tbl_print_material_info_idtbl_print_material_info = m.idtbl_print_material_info WHERE g.status = 1 AND g.tbl_print_material_info_idtbl_print_material_info <> 0 ORDER BY g.qty DESC LIMIT 5 ";
$resultqty = $this->db->query($sql);

//Low stock Product
$sql="SELECT COUNT(`idtbl_print_stock`) AS stockcount FROM `tbl_print_stock` LEFT JOIN `tbl_print_material_info` ON `tbl_print_material_info`.`idtbl_print_material_info`= `tbl_print_stock`.`tbl_print_material_info_idtbl_print_material_info` WHERE `tbl_print_stock`.`status` = 1 AND `tbl_print_stock`.`tbl_print_material_info_idtbl_print_material_info` <> 0 AND `tbl_print_stock`.`qty` < `tbl_print_material_info`.`reorderlevel`";
$lowstockinfo = $this->db->query($sql);
        ...
        <main>
            ...
            <div class="container-fluid mt-2 p-0 p-2">
                <div class="card rounded-0">
                                        ...
                                        <div class="col">
                                            <div class="card-body p-0 px-2 py-3 text-right">
                                                <h3 class="card-title text-success m-0 font-weight-bold"><a
                                                        class="text-success" href="#"> Print Materials
                                        ...
                                        <div class="col">
                                            <div class="card-body p-0 px-2 py-3 text-right">
                                                <h3 class="card-title text-danger m-0 font-weight-bold"><a
                                                        class="text-danger" href="#"> Machine
                                        ...
                                        <div class="col">
                                            <div class="card-body p-0 px-2 py-3 text-right">
                                                <h3 class="card-title text-warning m-0 font-weight-bold"><a
                                                        class="text-warning" href="#"> Spare Parts
                                        ...
                                        <div class="col">
                                            <div class="card-body p-0 px-2 py-3 text-right">
                                                <h3 class="card-title text-primary m-0 font-weight-bold"><a
                                                        class="text-primary" href="#"> Zero Stock Procucts
                                        ...
                                        <div class="col">
                                            <div class="card-body p-0 px-2 py-3 text-right">
                                                <h3 class="card-title text-info m-0 font-weight-bold"><a
                                                        class="text-info" href="#"> Low Stock Procucts
                    ...
                    <div class="row">
                        <div class="col-6">
                            <h6 class="small title-style"><span><b>Last Five Purchase</b></span></h6>
                            <table class="table table-striped table-bordered table-sm small">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">Rs.<?php echo $item->total; ?></td>
                                    </tr>
                                    <?php
											}
										} 
                        ...
                        <div class="col-6">
                            <h6 class="small title-style"><span><b>Top Five Purchase</b></span></h6>
                            <table class="table table-striped table-bordered table-sm small">
...
<div class="modal fade" id="tableModal2" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="card">
                        <div class="card-body p-0 p-2">
                            <div class="row">
                                <div class="col-12">
                                    <div class="scrollbar pb-3" id="style-2">
                                        <table class="table table-bordered table-striped table-lg nowrap"
                                            id="dataTable3">
                                            <thead>
                                                <tr>
                                                    <th>#ID</th>
