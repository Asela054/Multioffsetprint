...
$(document).ready(function() {
    ...
    // if (!sessionStorage.getItem('purchase_request_company_id')) {
    //             $('#companymodal').modal('show');
    // }
    // else{
    //     $('#company_id').val(sessionStorage.getItem('purchase_request_company_id'));
    //     $('#company_id').trigger('change');
    //     setTimeout(function() {
    //         $('#company_id').trigger('change');
    //         setTimeout(function() {
    //             $('#branch_id').val(sessionStorage.getItem('purchase_request_branch_id'));
    //         }, 200);
    //     }, 100);

    //     $('#savecompaydata').prop('checked', true);

    //     $('#f_company_id').val(sessionStorage.getItem('purchase_request_company_id'));
    //     $('#f_company_name').val(sessionStorage.getItem('purchase_request_company_name'));
    //     $('#f_branch_id').val(sessionStorage.getItem('purchase_request_branch_id'));
    //     $('#f_branch_name').val(sessionStorage.getItem('purchase_request_branch_name'));
    ...
    //             sessionStorage.setItem('purchase_request_company_id', company_id);
    //             sessionStorage.setItem('purchase_request_company_name', companyname);
    //             sessionStorage.setItem('purchase_request_branch_id', branch_id);
    //             sessionStorage.setItem('purchase_request_branch_name', branchname);
    //         } else {
    //             sessionStorage.removeItem('purchase_request_company_id');
    //             sessionStorage.removeItem('purchase_request_company_name');
    //             sessionStorage.removeItem('purchase_request_branch_id');
    //             sessionStorage.removeItem('purchase_request_branch_name');
    //         }
    ...
    $('#dataTable').DataTable({
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(data, type, full) {
                    var button = '';
                    // button += '<button class="btn btn-secondary btn-sm btnview mr-1" id="' +
                    // 	full['idtbl_print_material_info'] + '"><i class="fas fa-eye"></i></button>';
