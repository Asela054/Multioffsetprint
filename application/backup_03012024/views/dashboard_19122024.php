...
$sql="SELECT m.materialname, g.date, g.qty, g.unitprice, g.total 
	  FROM tbl_print_grndetail g INNER JOIN tbl_print_material_info m 
	  ON g.tbl_print_material_info_idtbl_print_material_info = m.idtbl_print_material_info 
	  WHERE g.status = 1 AND g.tbl_print_material_info_idtbl_print_material_info <> 0 ORDER BY g.date DESC LIMIT 5 ";
