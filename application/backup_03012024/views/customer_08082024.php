					...
					<div class="card-body p-0 p-2">
						...
						<form action="<?php echo base_url() ?>Customer/Customerinsertupdate"
							...
							<div class="row">
								...
								<div class="col-2">
									<div class="form-group mb-1">
										...
										<select class="form-control form-control-sm  px-0" name="vat_customer" id="vat_customer" required>
							...
							<div class="row">
								<div class="col-6">
									<div class="form-group mb-1">
										<label class="small font-weight-bold">Submit copy of VAT,NBT,SVAT
											Cetificate*</label>
										<div class="filebody">
											<div class="fileuploadcard">
												...
												<div class="drag-area">
													...
													<input id="certificates" name="cretificates" type="file"
														class="file" />
												</div>
			...
			"columns": [{
...

				{
					...
					"render": function (data, type, full) {
						var button = '';
						button += '<button class="btn btn-dark btn-sm btnimg mr-1 ';
						if (editcheck != 1) {
							button += 'd-none';
						}
						...
						button += '<a href="<?php echo base_url() ?>Customerjobs/index/' + full[
								'idtbl_customer'] +
							'" target="_self" class="btn btn-info btn-sm mr-1"><i class="fas fa-file"></i></a>';
