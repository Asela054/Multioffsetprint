				...
				<div class="container-fluid">
					<div class="page-header-content py-3">
						<h1 class="page-header-title font-weight-light">
							...
							<span>Job - [<?php echo json_decode($jobDetails,true)[0]['job']; ?>]/ Cost Item - [<?php echo json_decode($jobDetails,true)[0]['costitemname']; ?>]/ Qty - [<?php echo json_decode($jobDetails,true)[0]['qty']; ?>]</span>
						</h1>
					</div>
				</div>
			</div>
					...
					<div class="card-body p-0 p-2">
						<form id='createJobForm' autocomplete="off">
							<div class="row">
								...
								<div class="col-3">
									<div class="form-group mb-1">
										<label class="small font-weight-bold">Board type*</label>
								...
								<div class="col-3">
									<div class="form-group mb-1">
										...
										<select class="form-control form-control-sm" name="material_type" id="material_type"
											required>
											<option value="">Select</option>
											<?php foreach ($materialList->result() as $rowMaterial) { ?>
											<option value="<?php echo $rowMaterial->idtbl_material_info ?>">
								...
								<div class='col-md-12 mt-3'>
									<div class="text-right">
										...
										<input type="hidden" class="form-control form-control-sm" name="collorsummary"
											id="collorsummary" required>
									</div>
								</div>
								<div class="col-12 mt-4">
									<div class="form-group mb-1">
								...
								<div class='col-md-12 mt-3'>
									<div class="text-right">
										...
										<input type="hidden" id = 'totalsummary' name = 'totalsummary'>
									</div>
								</div>
								<div class="col">
...
<script>
	...
	function calculateFullTotal(){
		...
		var collorsummary = parseFloat($('#collorsummary').val())

		var totsummary = bottomsummary + topsummary + collorsummary;
