<?php
class Serviceitemlistinfo extends CI_Model{
    public function Serviceitemlistinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->insert('tbl_service_item_list', $data);
            ...
            $this->db->update('tbl_service_item_list', $data);
    ...
    public function Serviceitemlistedit(){
        ...
        $obj->servicetype=$respond->row(0)->service_type;
