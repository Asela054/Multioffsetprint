                        ...
                        <table width="100%" border="0" cellspacing="0">
                            ...
                            <tr>
                                <td valign="top">
                                    ...
                                    <p><b>Department: </b>' .$query->row()->name.'</p>
                                ...
                                <td align="right" width="30%" valign="top">
                                    <p>MO/IR000-<b>'.$query->row()->idtbl_grn_req. '</b></p>
                                </td>
                            </tr>
                    ...
                    <td colspan="3">
                        <table class="tablec">
                            ...
                            foreach ($query->result() as $row) {
                               ...
                               if($row->tbl_material_id == 0){
                                $html .= '<td class="tdc">'. $row->machine . ' / ' . $row->machinecode .' - ' . $row->type .'</td>';
                               }else{$html .= '<td class="tdc">'. $row->materialname . ' / ' . $row->materialinfocode .' - ' . $row->type .'</td>';}
