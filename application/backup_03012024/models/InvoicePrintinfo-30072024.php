    ...
    <table style="width:100%;">
                <tr>
                    ...
                    <td style="width: 50%;text-align: left;vertical-align: top;">
                        ...
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-20px;margin-left:145px;   font-family: Arial, sans-serif;">'.$companydetails->row()->companyaddress.'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-17px;margin-left:145px;margin-bottom:20px;   font-family: Arial, sans-serif;">Phone : '.$companydetails->row()->companymobile.'/'.$companydetails->row()->companyphone.'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-23px;margin-left:145px;margin-bottom:20px;   font-family: Arial, sans-serif;">E-Mail : '.$companydetails->row()->companyemail.'</h3>
                        ...
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-18px;margin-left:145px;   font-family: Arial, sans-serif;">Date : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$respond->row(0)->orderdate.'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-18px;margin-left:145px;   font-family: Arial, sans-serif;">Our Vat No: &nbsp; 103305667-7000</h3>
                    </td>
                </tr>
        </table>
