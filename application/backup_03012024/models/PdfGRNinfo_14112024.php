...
class PdfGRNinfo extends CI_Model {
    public function pdfgrnget($x) {
        ...
        foreach ($query->result() as $rowlist) {        
            ...
            if ($rowlist->tbl_order_type_idtbl_order_type == 2) {
                $itemcode='';
                $itemdesc=$rowlist->service_type;
            }
            if ($rowlist->tbl_order_type_idtbl_order_type == 4) {
            ...
            <table style="width:100%;border-collapse: collapse;">
                ...
                <tr>
                    <td style="text-align: right;vertical-align: top;padding: 0px;">
                        <p style="margin:0px;font-size:13px;font-weight: bold;text-transform: uppercase;">GRN No: MO/GRN-0000'. $query->row()->idtbl_print_grn .'</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table style="width:100%;border-collapse: collapse;">
                            <td width="40%" style="vertical-align: top;">
                                <p style="margin:0px;font-size: 13px;font-weight: bold;">'. $query->row()->name .'</p>
    ...
    public function VoucherPdf($x){
		...
		$this->db->join('tbl_company', 'tbl_company.idtbl_company = tbl_grn_vouchar_import_cost.company_id', 'left');
        $this->db->join('tbl_company_branch', 'tbl_company_branch.idtbl_company_branch = tbl_grn_vouchar_import_cost.company_branch_id', 'left');
                ...
                <table style="width:100%;border-collapse: collapse;">
                    ...
                    <tr>
                        <td width="55%" style="vertical-align: top;padding:0px;padding-top: 15px;padding-bottom: 15px;">
                            <p style="margin:0px;font-size:13px;font-weight: bold;">To: '.$respond->row(0)->name.'</p>
