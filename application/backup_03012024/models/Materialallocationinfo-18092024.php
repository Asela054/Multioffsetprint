...
class Materialallocationinfo extends CI_Model{
    ...
    public function Getjobvisequotations() {
		...
		$this->db->join('tbl_customerinquiry_detail', 'tbl_customerinquiry_detail.job_id = tbl_jobquatation.customer_jobno');
		...
		$this->db->where('tbl_jobquatation.customer_jobno', $recordID);
    ...
    public function Getquotationdetailsfortable() {
		...
		$this->db->join('tbl_print_material_info', 'tbl_print_material_info.idtbl_print_material_info = tbl_jobquotation_varnish_details.tbl_varnish_idtbl_varnish');
		$this->db->where('tbl_jobquatation.status', 1);
