<?php class Goodreceiveinfo extends CI_Model {
	...
	public function Goodreceiveview() {
		...
		foreach($responddetail->result() as $roworderinfo) {
					...
					if($roworderinfo->tbl_order_type_idtbl_order_type==3) {
						$html.='<tr>
					<td>'.$roworderinfo->materialname.'/ '.$roworderinfo->materialinfocode.'</td><td>'.$roworderinfo->unitprice.'</td><td class="text-center">'.$roworderinfo->qty.'</td><td class="text-center">'.$roworderinfo->measure_type.'</td><td class="text-center">'.$roworderinfo->unit_discount.'</td><td class="text-right">'.$roworderinfo->total.'</td></tr>';
	...
	public function Getsupplier() {
		...
		$this->db->select('tbl_supplier.idtbl_supplier, tbl_supplier.name');
		$this->db->from('tbl_print_porder');
