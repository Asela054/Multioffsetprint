    ...
    <table style="width:100%;">
                <tr>
                    <td style="text-align: left;vertical-align: top;">
                        ...
                        <h3 style="font-size:11px;  font-weight:bold;margin-top:-20px;   font-family: Arial, sans-serif;">To : '.$respond->row(0)->name.'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-18px;margin-left:24px; font-family: Arial, sans-serif;"> '.$respond->row(0)->address_line1.',</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-18px;margin-left:24px; font-family: Arial, sans-serif;"> '.$respond->row(0)->address_line2.',</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-18px;margin-left:24px; font-family: Arial, sans-serif;"> '.$respond->row(0)->city.'.</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-18px;margin-left:24px; font-family: Arial, sans-serif;"> '.$respond->row(0)->telephone_no.'</h3>

                         <h3 style="font-size:11px;  font-weight:bold;margin-top:-8px;   font-family: Arial, sans-serif;">Atten ..................................</h3>
                    </td>
                    <td style="text-align: left;vertical-align: top;">
                        <h3 style="font-size:15px;  font-weight:bold;margin-top:-10px;margin-left:380px;  font-family: Arial, sans-serif;">'.$companydetails->row()->companyname.'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-20px;margin-left:380px;   font-family: Arial, sans-serif;">'.$companydetails->row()->companyaddress.'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-17px;margin-left:380px;margin-bottom:20px;   font-family: Arial, sans-serif;">Phone : '.$companydetails->row()->companymobile.'/'.$companydetails->row()->companyphone.'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-23px;margin-left:380px;margin-bottom:20px;   font-family: Arial, sans-serif;">E-Mail : '.$companydetails->row()->companyemail.'</h3>

                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-14px;margin-left:380px;   font-family: Arial, sans-serif;">PO No: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; MO/PO-000'.$respond->row(0)->idtbl_print_porder.'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-18px;margin-left:380px;   font-family: Arial, sans-serif;">Date : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$respond->row(0)->orderdate.'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-18px;margin-left:380px;   font-family: Arial, sans-serif;">Our Vat No: &nbsp; 103305667-7000</h3>
                    </td>
                </tr>
        </table>
        
        <table class="tg" style="table-layout: fixed;padding:3px;width:100%;margin-top:-18px;border-collapse: collapse;">
            <tr>
        ...
        <table style="width:100%;margin-top:-25px;">
                <tr>
                    <td style="width: 12%;text-align: left;vertical-align: top;">
                        ...
                        <h3 style="font-size:11px;  font-weight:bold;margin-top:-15px;   font-family: Arial, sans-serif;">PR No. :</h3>
                        <h3 style="font-size:11px;  font-weight:bold;margin-top:-15px;   font-family: Arial, sans-serif;">GRV No. :</h3>
                        <h3 style="font-size:11px;  font-weight:bold;margin-top:-15px;margin-bottom:10px;   font-family: Arial, sans-serif;">INV No. :</h3>
                    ...
                    <td style="width: 10%;text-align: left;vertical-align: top;">
                        <h3 style="font-size:11px;  font-weight:bold;margin-top:46px;margin-left:30px;   font-family: Arial, sans-serif;">Contact Person</h3>
                     ...
                     <td style="width: 10%;text-align: center;vertical-align: top;">
                        <h3 style="font-size:15px;  font-weight:bold;margin-top:22px;  font-family: Arial, sans-serif;">'.$companydetails->row()->companyname.'</h3>
