...
class Materialdetailinfo extends CI_Model{
    ...
    public function UOMqtyinsert(){
        ...
        $show_measurement=$this->input->post('show_measurement');
        ...
        $updatedatetime=date('Y-m-d H:i:s');  
            ...
            $this->db->insert('tbl_material_uom_qty', $data);
    ...
    public function Getadduomqty()
    {
        ...
        $this->db->select('idtbl_material_uom_qty, qty, measure_type');
        ...
        $this->db->where('tbl_print_material_info_idtbl_print_material_info', $id);
        $query = $this->db->get();
