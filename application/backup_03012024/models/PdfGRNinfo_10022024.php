...
class PdfGRNinfo extends CI_Model {
    ...
    public function pdfgrnget($x) {
        ...
        $this->db->join('tbl_print_grndetail', 'idtbl_print_grn = tbl_print_grndetail.tbl_print_grn_idtbl_print_grn', 'left');
        ...
        $this->db->join('tbl_print_porder_req_detail', 'tbl_print_porder.tbl_print_porder_req_idtbl_print_porder_req = tbl_print_porder_req_detail.idtbl_print_porder_req_detail', 'left');
        $this->db->join('tbl_measurements', 'tbl_print_porder_req_detail.tbl_measurements_id = tbl_measurements.idtbl_mesurements', 'left');
        ...
        <div>
            ...
            <table border="0" width="100%">
                ...
                <tr>
                    <th colspan="3" align="right" class="postion pos2"><h5>GRN No: NO</h5></th>
                </tr>
            ...
            <table border="0" width="100%">
                <tr>
                    ...
                    <td class="table2"></td>
                    <td class="table2" width="120px">
                        <p style="font-size:9;"><b>Date</b></p>
                        <p style="font-size:9;"><b>Order No</b></p>
                        <p style="font-size:9;"><b>Supplier Invoice</b></p>
                        <p style="font-size:9;"><b>Location</b></p>
                        <p style="font-size:9;"><b>Vehicle No</b></p>
                    </td>
                    <td class="table2" width="20px" align="center">
                        <p>:</p>
                        <p>:</p>
                        <p>:</p>
                        <p>:</p>
                    ...
                    <td class="table2" width="120px">
                        <p style="font-size:9;">'. $query->row()->grndate .'</p>
                        <p style="font-size:9;">'. $query->row()->batchno .'</p>
                        <p style="font-size:9;"> NO </p>
                        <p style="font-size:9;">'. $query->row()->location .'</p>
                        <p style="font-size:9;">'. $query->row()->bus_reg_no .'</p>
                    </td>
                </tr>
            </table>
                    ...
                    foreach ($query->result() as $row) {
                        ...
                        if ($query->row()->tbl_order_type_idtbl_order_type == 2) {
                            ...
                            <tr>
                                ...
                                <td class="tdc"> </td>
                                <td class="tdc" align="right">22.000</td>
                                <td class="tdc" align="center">' . $row->measure_type . '</td>
                                <td class="tdc" align="right">' . $row->unitprice . '</td>
                                <td class="tdc" align="right" style="padding-right:11px;">' . $row->total . '</td>
                            </tr>';
                    ...
                    <tr>
                            ...
                            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p style="margin:0; padding-right:0; font-size:8;" align="left"><b>Total (Icl)</b></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td class="tdc tddc" align="right">
                            <table border="0" width="100%" cellspacing="0" cellpadding="0" align="right">
                                <tr>
                                    <td align="right">
                                        <p style="font-size:8;"><b>'. $query->row()->subtotal .'</b></p>
                                        <p style="font-size:8;"><b>No</b></p>
                                        <p style="font-size:8;"><b>'. $query->row()->nettotal .'</b></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
