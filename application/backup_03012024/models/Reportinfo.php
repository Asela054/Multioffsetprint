...
class Reportinfo extends CI_Model {
    ...
    public function Categoryget() {
        ...
        $this->db->select('paper, idtbl_material_type');
    ...
    public function stockReport() {
        ...
        $this->db->select('tbl_print_stock.idtbl_print_stock, tbl_print_stock.batchno,tbl_location.location,tbl_print_stock.qty,tbl_print_stock.unitprice,tbl_print_stock.total,tbl_print_material_info.materialname,tbl_machine.machine,tbl_spareparts.spare_part_name,tbl_material_type.paper');
        ...
        $this->db->join('tbl_machine', 'tbl_machine.idtbl_machine = tbl_print_stock.tbl_machine_id', 'left');
        $this->db->join('tbl_spareparts', 'tbl_spareparts.idtbl_spareparts = tbl_print_stock.tbl_sparepart_id', 'left');
        ...
        if ($type == '1') {
            ...
            $this->db->where('tbl_print_stock.tbl_machine_id', 0);
            $this->db->where('tbl_print_stock.tbl_sparepart_id', 0);
            $this->db->where('tbl_print_stock.company_id', $companyID);
