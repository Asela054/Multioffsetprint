            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="width: 50%;text-align: left;vertical-align: top;">
                        ...
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-12px;margin-left:145px; font-family: Arial, sans-serif;">Phone : '.$companydetails->row()->companymobile.'/'.$companydetails->row()->companyphone.'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-12px;margin-left:145px;margin-bottom:20px;   font-family: Arial, sans-serif;">E-Mail : '.$companydetails->row()->companyemail.'</h3>

                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-0px;margin-left:145px;   font-family: Arial, sans-serif;">Date : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; '. $query->row()->date .'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-14px;margin-left:145px;   font-family: Arial, sans-serif;">Dispatch No : &nbsp;&nbsp;&nbsp;&nbsp;DPN000'. $query->row()->idtbl_print_dispatch .'</h3>
                        <h3 style="font-size:11px;  font-weight:normal;margin-top:-14px;margin-left:145px;   font-family: Arial, sans-serif;">PO No: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'. $query->row()->ponum .'</h3>
                    </td>
                </tr>
        </table>
