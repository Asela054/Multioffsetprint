...
class Chargesdetailinfo extends CI_Model {
    ...
    public function Chargesdetailinsertupdate() {
        ...
        $prev_effective_date = date('Y-m-d', strtotime($charges_date . ' - 1 day'));
        
        $this->db->set('charges_effective', $prev_effective_date)
                    ->where('idtbl_charges_detail', $existing_records->idtbl_charges_detail)
                    ->update('tbl_charges_detail');
        }
