...
class Quatationinfo extends CI_Model{
    ...
    public function Getmaterialvarnishlist() {
        $this->db->select('`idtbl_print_material_info`, `materialname`');
        $this->db->from('tbl_print_material_info');
        $this->db->where('tbl_material_type_idtbl_material_type', 8);
        $this->db->where('status', 1);
        return $respond=$this->db->get();
    }
    public function Getmateriallaminationlist() {
        $this->db->select('`idtbl_print_material_info`, `materialname`');
        $this->db->from('tbl_print_material_info');
        $this->db->where('tbl_material_type_idtbl_material_type', 6);
        $this->db->where('status', 1);
        return $respond=$this->db->get();
    }
    public function Getmateriallist() {
        ...
        $this->db->from('tbl_print_material_info');
        $this->db->where('status', 1);
        $this->db->where_in('tbl_material_type_idtbl_material_type', [1, 2]);
        return $respond=$this->db->get();
    }
    ...
    public function get_job_details_by_job_id($job_id) {
        $this->db->select('idtbl_customerinquiry_detail, job_no, qty');
        $this->db->from('tbl_customerinquiry_detail');
    ...
    public function Quotationinsertupdate(){
        ...
        if($recordOption==1){
            ...
            if($varnish != ''){
                ...
                'tbl_user_idtbl_user' => $userID,
                'tbl_jobquatation_idtbl_jobquatation' => $insert_id,
                'tbl_print_material_info_idtbl_print_material_info' => $varnish,
                );
            ...
            if($lamination != ''){
                ...
                'tbl_user_idtbl_user' => $userID,
                'tbl_jobquatation_idtbl_jobquatation' => $insert_id,
                'tbl_print_material_info_idtbl_print_material_info' => $lamination,
                );
                ...
                if( $filmchrgerow_id != ''){
                    ...
                    $filmchagedata = array(
                        ...
                        'tbl_user_idtbl_user' => $userID );
                         ...
                         $this->db->where('idtbl_jobquotation_filmcharge_details', $filmchrgerow_id);
                         $this->db->update('tbl_jobquotation_filmcharge_details', $filmchagedata);
