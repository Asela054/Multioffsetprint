    ...
    public function UpdateStockForMaterialIssue()
    {
        ...
        foreach ($tableData2 as $rowtabledata2) {
            ...
            if ($issuedStatus == 0) {
                ...
                $this->db->where('tbl_inquiry_allocated_materials.idtbl_inquiry_allocated_materials', $inquiryallocmaterialId);
                ...
                $data = [
                    ...
                    "accountcrno" => "115",
                    "narrationcr" => "Material Stock",
                    "accountdrno" => "114",
                    "narrationdr" => "Work in Progress",
                    "updatedatetime" => $date,
                ];
