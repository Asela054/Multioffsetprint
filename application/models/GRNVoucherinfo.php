...
class GRNVoucherinfo extends CI_Model{
    ...
    public function Goodreceivevoucherview() {
        ...
        <div class="row">
            ...
            <div class="col-6 small"><label class="small font-weight-bold text-dark mb-1">Supplier:</label> '.$respond->row(0)->suppliername.'<br><label class="small font-weight-bold text-dark mb-1">Phone:</label> '.$respond->row(0)->telephone_no.'<br><label class="small font-weight-bold text-dark mb-1">Address:</label> '.$respond->row(0)->address.'<br><label class="small font-weight-bold text-dark mb-1">Invoice no:</label> '.$respond->row(0)->invoiceno.'</div>
        </div>
