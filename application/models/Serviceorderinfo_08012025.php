<?php
class Serviceorderinfo extends CI_Model{
    ...
    public function Serviceorderinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->where('idtbl_service_order', $recordID);
            $this->db->update('tbl_service_order', $data);
    ...
    public function Serviceorderedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_service_order;
