...
class Issuegoodreceiveinfo extends CI_Model{
	...
	public function Issuepdf($x)
	{
		...
		$this->db->select('tbl_print_issuedetail.*, tbl_print_issue.ordertype, tbl_order_type.type, tbl_location.location, departments.name, tbl_print_issue.idtbl_print_issue, tbl_print_material_info.materialname, tbl_machine.machine');
		$this->db->from('tbl_print_issuedetail');
