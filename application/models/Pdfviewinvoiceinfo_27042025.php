					  ...
					  <table width="100%" border="0" cellspacing="10">
						  <tr>
							  <td valign="top">
								  ...
								  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $query->row()->city . '</p>
								  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $query->row()->state . '</p>
								  <p class="pono">P.O. No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;&nbsp;PO-'. $query->row()->ponum .' on '. $query->row()->date .'</p>';
                                  if ($vat_customer == 1) {
                    ...
                    <td colspan="3">
                        <table class="tablec" border="0">
							...
							foreach ($query->result() as $row) {
								...
								$html .= '
									<tr>
										<td class="tdc">' . $row->dispatch_number .'</td>
										<td class="tdc">' . $jobname . '</td>
										<td class="tdc" style="text-align:center;">' . $row->quantity . '</td>
										<td class="tdc" style="text-align:center;">' . $row->measure_type . '</td>
										<td class="tdc" style="text-align:right;">' . number_format($unitprice, 2, '.', ',') . '</td>
							...
							if ($query->row()->subtotal != 0) {
								...
								<tbody class="foot">
									<tr>
										...
										<td style="text-align:center; border: 0px solid black; border-left: 0px solid black; border-right: 0px solid black; padding: 10px;" width="6%"></td>
										<td width="35%" style="text-align:right; border: 0px solid black; border-left: 0px solid black; padding: 10px;"><strong style="font-size: 14px;">' . $invoiceLabel . '</strong></td>
										<td width="25%" style="' . $border . 'text-align:right; border-right: none; border-left: none; border-top: 1px solid black; padding: 10px;"><strong style="font-size: 14px;">' . number_format($fulltotal, 2, '.', ',') . '</strong></td>
									</tr>
								</tbody>';
							}
							...
							if ($query->row()->vat_amount != 0 && $vat_customer != 0) {
								...
								$html .= '
									<tbody class="foot">
										<tr>
											<td width="50%" style="text-align:left; border: 0px solid black; border-left: 0px solid black; padding: 10px;">
												<strong style="font-size: 13px;">' . $vat_label . '</strong>
											</td>
											<td width="10%" style="text-align:left; border: 0px solid black; padding: 10px; font-size: 13px;">' . number_format($vat_amount, 2, '.', ',') . '</td>
										</tr>
									</tbody>';
							}							
