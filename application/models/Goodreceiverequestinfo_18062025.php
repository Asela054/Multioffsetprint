...
class Goodreceiverequestinfo extends CI_Model{
    ...
    public function Getordertype(){
        ...
        $this->db->where('status', 1);
        $this->db->where_in('idtbl_order_type', array(3, 4));
        return $respond=$this->db->get();
    }
    ...
    public function Getproductaccosupplier(){
        ...
        $sql="SELECT `idtbl_print_material_info`, `materialinfocode`, `materialname` FROM `tbl_print_material_info` WHERE `tbl_company_idtbl_company`=$comapnyID AND `tbl_company_branch_idtbl_company_branch`=$branchID";
    ...
    public function Grnorderview(){
        ...
        <div style="margin-left:375px;"></div></div>
        <div class="row">
