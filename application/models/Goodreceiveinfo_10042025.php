	...
	public function Goodreceiveview() {
		...
		foreach($responddetail->result() as $roworderinfo) {
			...
			if($roworderinfo->tbl_order_type_idtbl_order_type==3) {
				...
				$html.='<tr><td>'.$roworderinfo->machine.'/ '.$roworderinfo->machinecode.'</td><td>'.$roworderinfo->unitprice.'</td><td class="text-center">'.$roworderinfo->qty.'</td><td class="text-center">'.$roworderinfo->measure_type.'</td><td class="text-center">'.$roworderinfo->unit_discount.'</td><td class="text-right">'.$total.'</td></tr>';
			}
			else if($roworderinfo->tbl_order_type_idtbl_order_type==1) {
				$html.='<tr><td>'.$roworderinfo->spare_part_name.'</td><td>'.$roworderinfo->unitprice.'</td><td class="text-center">'.$roworderinfo->qty.'</td><td class="text-center">'.$roworderinfo->measure_type.'</td><td class="text-center">'.$roworderinfo->unit_discount.'</td><td class="text-right">'.$total.'</td></tr>';
			}
		}
