...
class Vehicleinfo extends CI_Model{
    ...
    public function Vehicleinsertupdate(){
        ...
        $selected_account_id=$this->input->post('selected_account_id');
        $selected_account_type=$this->input->post('selected_account_type');
        ...
        if ($selected_account_type == 1) {
            $accountData['tbl_account_idtbl_account'] = $selected_account_id;
        } elseif ($selected_account_type == 2) {
            $accountData['tbl_account_detail_idtbl_account_detail'] = $selected_account_id;
        }
