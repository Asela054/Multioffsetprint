...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <div class="collapse <?php if($functionmenu=="Customer"| $functionmenu=="Customerinquiry" | $functionmenu=="Customerinquiryforapprove" | $functionmenu=="Approvedcustomerinquiry"|$functionmenu=="NewDeliveryPlan" | $functionmenu=="OrderReconsilation" | $functionmenu=="PlanDetails"){echo 'show';} ?>" id="jobmanagement" data-parent="#accordionSidenav">
            ...
            <a class="nav-link p-0 px-3 py-2 text-dark" href="<?php echo base_url().'Jobcard'; ?>">
                <div class="nav-link-icon"><i class="fa fa-file-alt"></i>
                </div>
                Job Card
            </a>      
