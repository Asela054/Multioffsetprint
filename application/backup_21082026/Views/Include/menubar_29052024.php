...
<nav class="sidenav shadow-right sidenav-light">
	<div class="sidenav-menu">
		<div class="nav accordion" id="accordionSidenav">
			...
			<div class="collapse <?php if($functionmenu=="Rptservicesummery" | $functionmenu=="Rptsalereport" |  $functionmenu=="Rptroute" |  $functionmenu=="Rptserviceitem" |  $functionmenu=="Rptrefitemreport" | $functionmenu=="Rptrefsalesreport" | $functionmenu=="MachineAllocationReport" | $functionmenu=="JobSummaryReport" | $functionmenu=="StockReport" | $functionmenu=="VatReport" | $functionmenu=="SalesReport" | $functionmenu=="AdvancedGrnSearch"){echo 'show';} ?>"
				...
				<nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
					...
					<a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'AdvancedGrnSearch'; ?>">GRN Report</a>
