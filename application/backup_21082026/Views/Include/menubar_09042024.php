...
<nav class="sidenav shadow-right sidenav-light">
	<div class="sidenav-menu">
		<div class="nav accordion" id="accordionSidenav">
			...
			<div class="collapse <?php if($functionmenu=="Machine" | $functionmenu=="Machinetype"  | $functionmenu=="Factory" | $functionmenu=="MachineIssueCategory" | $functionmenu=="Machinemodels" | $functionmenu=="Spareparts" | $functionmenu=="Machineservice"){echo 'show';} ?>"
			...
			<?php  } if(menucheck($menuprivilegearray, 32)==1 | menucheck($menuprivilegearray, 33)==1 | menucheck($menuprivilegearray, 66)==1  | menucheck($menuprivilegearray, 85)==1  | menucheck($menuprivilegearray, 86)==1 | menucheck($menuprivilegearray, 107)==1 | menucheck($menuprivilegearray, 127)==1 | menucheck($menuprivilegearray, 128)==1) ?>
			<a class="nav-link p-0 px-3 py-2 collapsed text-dark" href="javascript:void(0);" data-toggle="collapse"
			...
			<div class="collapse <?php if($functionmenu=="Rptservicesummery" | $functionmenu=="Rptsalereport" |  $functionmenu=="Rptroute" |  $functionmenu=="Rptserviceitem" |  $functionmenu=="Rptrefitemreport" | $functionmenu=="Rptrefsalesreport" | $functionmenu=="MachineAllocationReport" | $functionmenu=="JobSummaryReport" | $functionmenu=="StockReport" | $functionmenu=="VatReport" | $functionmenu=="SalesReport"){echo 'show';} ?>"
