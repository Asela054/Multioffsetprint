...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <div class="collapse <?php if($functionmenu=="Location" | $functionmenu=="Measurements" | $functionmenu=="Servicetype"| $functionmenu=="Taxcontrol" |$functionmenu=="Serviceitemlist" | $functionmenu=="Charges" |$functionmenu=="Chargesdetail" | $functionmenu=="Expences"){echo 'show';} ?>" id="collapsMasterfile" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark"
                        href="<?php echo base_url().'UOMconversions'; ?>">UOM Conversions</a>
                    <?php } ?>
                </nav>
            </div>

            <!-- Job Management Menu New Added -->
            <?php } if(menucheck($menuprivilegearray, 4)==1 | menucheck($menuprivilegearray, 26)==1 | menucheck($menuprivilegearray, 27)==1 | menucheck($menuprivilegearray, 28)==1 | menucheck($menuprivilegearray, 42)==1 | menucheck($menuprivilegearray, 43)==1 | menucheck($menuprivilegearray, 44)==1 | menucheck($menuprivilegearray, 150)==1){ ?>
            <a class="nav-link p-0 px-3 py-2 collapsed text-dark" href="javascript:void(0);" data-toggle="collapse"
            ...
            <div class="collapse <?php if($functionmenu=="Customer"| $functionmenu=="Customerinquiry" | $functionmenu=="Customerinquiryforapprove" | $functionmenu=="Approvedcustomerinquiry" | $functionmenu=="Quatation" | $functionmenu=="NewDeliveryPlan" | $functionmenu=="OrderReconsilation" | $functionmenu=="PlanDetails" | $functionmenu=="MaterialAllocation"){echo 'show';} ?>" id="jobmanagement" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion">
                    ...
                    <div class="collapse <?php if($functionmenu=="Customerinquiry" | $functionmenu=="Customerinquiryforapprove" | $functionmenu=="Approvedcustomerinquiry" | $functionmenu=="Quatation" | $functionmenu=="MaterialAllocation") {echo 'show';} ?>"
                        id="collapsecusinquiry" data-parent="#collapsecusinquiry">
                        <nav class="sidenav-menu-nested nav accordion">
                            ...
                            <?php } if(menucheck($menuprivilegearray, 150)==1){ ?>
                                <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Quatation'; ?>">Quotation</a>
                    ...
                    <div class="collapse <?php if($functionmenu=="NewDeliveryPlan" | $functionmenu=="OrderReconsilation" | $functionmenu=="PlanDetails") {echo 'show';} ?>"
                        id="collapsedeliveryplan" data-parent="#collapsedeliveryplan">
                        <nav class="sidenav-menu-nested nav accordion">
            ...
            <div class="collapse <?php if($functionmenu=="Supplier" | $functionmenu=="Suppliertype" |  $functionmenu=="Purchaseorder" | $functionmenu=="Newpurchaserequest"  | $functionmenu=="ApprovedPurchaseOrder" | $functionmenu=="ApprovedGrn" | $functionmenu=="ApproveServicePorder"){echo 'show';} ?>" id="finance" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark"  href="<?php echo base_url().'ApprovedPurchaseOrder'; ?>">Approved Purchase Orders</a>
                    <?php } if(menucheck($menuprivilegearray, 96)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark"  href="<?php echo base_url().'ApproveServicePorder'; ?>">Approved Service P-order</a>
                    <?php } if(menucheck($menuprivilegearray, 99)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark"  href="<?php echo base_url().'ApprovedGrn'; ?>">Approved GRN</a>
                    <?php } ?>
                </nav>
            </div>
            ...
            <div class="collapse <?php if($functionmenu=="Dispatchnote" | $functionmenu=="Invoice" | $functionmenu=="Deletedinvoice" | $functionmenu=="Canceledinvoice"){echo 'show';} ?>"
                ...
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Deletedinvoice'; ?>">Deleted Invoice </a>
                    <?php } if(menucheck($menuprivilegearray, 135)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Canceledinvoice'; ?>">Canceled Invoice </a>
                    <?php } ?>
                </nav>
            </div>
            ...
            <div class="collapse <?php if($functionmenu=="Machine" | $functionmenu=="Machinetype"  | $functionmenu=="Factory" | $functionmenu=="MachineIssueCategory" | $functionmenu=="Machinemodels" | $functionmenu=="Spareparts" | $functionmenu=="Machineservice" | $functionmenu=="ServiceItemAllocate" | $functionmenu=="ServiceItemReceive" | $functionmenu=="ServiceItemIssues" | $functionmenu=="Usedserviceitems"){echo 'show';} ?>"
                ...
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Machinemodels'; ?>">Machine Model</a>
                    <?php } if(menucheck($menuprivilegearray, 130)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Spareparts'; ?>">Machine Spareparts</a>
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Usedserviceitems'; ?>">Used Service Items</a>
                    <?php } if(menucheck($menuprivilegearray, 138)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'ServiceItemIssues'; ?>">Service Item Issues</a>
                    <?php } ?>
                </nav>
            </div>
            ...
            <div class="collapse <?php if($functionmenu=="Foiling" | $functionmenu=="Lamination" | $functionmenu=="Rimming" | $functionmenu=="Varnish" | $functionmenu=="Materialtype" | $functionmenu=="Plates" | $functionmenu=="Color" | $functionmenu=="Materialdetail" | $functionmenu=="Board" | $functionmenu=="Boardtype"  | $functionmenu=="Boardsize" | $functionmenu=="JobTaskList" | $functionmenu=="Processplan" | $functionmenu=="Machinealloction" | $functionmenu=="AllocatedMachines" | $functionmenu=="BreakDownDashboard" |$functionmenu=="CategoryGauge" |$functionmenu=="Machinealloction" |$functionmenu=="AllocatedMachines" |$functionmenu=="BreakDownDashboard"){echo 'show';} ?>" id="collapseproduction" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion">
                    <?php if(menucheck($menuprivilegearray, 59)==1 | menucheck($menuprivilegearray, 13)==1 | menucheck($menuprivilegearray, 101)==1 | menucheck($menuprivilegearray, 25)==1 | menucheck($menuprivilegearray, 9)==1 | menucheck($menuprivilegearray, 10)==1 | menucheck($menuprivilegearray, 11)==1 | menucheck($menuprivilegearray, 12)==1 | menucheck($menuprivilegearray, 14)==1 | menucheck($menuprivilegearray, 24)==1 | menucheck($menuprivilegearray, 30)==1 | menucheck($menuprivilegearray, 31)==1 | menucheck($menuprivilegearray, 40)==1 | menucheck($menuprivilegearray, 41)==1){ ?>
                    <div class="collapse <?php if($functionmenu=="Foiling" | $functionmenu=="Lamination" | $functionmenu=="Rimming" | $functionmenu=="Varnish" | $functionmenu=="Materialtype" | $functionmenu=="Plates" | $functionmenu=="Color" | $functionmenu=="Materialdetail" | $functionmenu=="Board" | $functionmenu=="Boardtype"  | $functionmenu=="Boardsize" | $functionmenu=="JobTaskList" | $functionmenu=="Processplan" | $functionmenu=="Machinealloction" | $functionmenu=="AllocatedMachines" | $functionmenu=="BreakDownDashboard" |$functionmenu=="CategoryGauge"){echo 'show';} ?>" id="collapseproduction" data-parent="#accordionSidenav">
                        <a class="nav-link p-0 px-3 py-2 collapsed text-dark" href="javascript:void(0);"
