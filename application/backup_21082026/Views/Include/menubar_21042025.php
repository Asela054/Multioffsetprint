...
if($functionmenu2=='Useraccount'){
    ...
    $addcheck=checkprivilege($menuprivilegearray, 157, 1);
    $editcheck=checkprivilege($menuprivilegearray, 157, 2);
    $statuscheck=checkprivilege($menuprivilegearray, 157, 3);
    $deletecheck=checkprivilege($menuprivilegearray, 157, 4);
}
        ...
        <div class="nav accordion" id="accordionSidenav">
            ...
            <div class="collapse <?php if($functionmenu=="Customer"| $functionmenu=="Customerinquiry" | $functionmenu=="Customerinquiryforapprove" | $functionmenu=="Approvedcustomerinquiry" | $functionmenu=="Quatation" | $functionmenu=="NewDeliveryPlan" | $functionmenu=="OrderReconsilation" | $functionmenu=="PlanDetails" | $functionmenu=="MaterialAllocation" | $functionmenu=="Newcustomerjobs"){echo 'show';} ?>" id="jobmanagement" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion">
                    ...
                    <?php } if(menucheck($menuprivilegearray, 157)==1){ ?>
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark"  href="<?php echo base_url().'MaterialAllocation'; ?>">Issue Material</a>
                    <?php }?>
                </nav>
            </div>
